    ...
    <div class="box box-success">
        <div class="box-body">
            ...
            <div style="display:none;float: right;width: 200px;margin: 0px;height: 35px;position: absolute;left: 70%;z-index: 111;top:22px">
                <a title="Click here to print" target="_blank" href="<?php echo e(route('missingInvoiceReportsPDF')); ?>"><i class="fa fa-print btn btn-primary"></i></a>
            </div>
...
<script type="text/javascript">
    ...
    function DatatableInitiate(cargoType = 'Cargo', fromDate = '', toDate = '') {
        ...
        var table = $('#example').DataTable({
            ...
            "ajax": {
                url: "<?php echo e(url('reports/listmissingInvoiceReport')); ?>", // json datasource
                data: function(d) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.custom', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/php/cargo/resources/views/reports/missinginvoiceReports.blade.php ENDPATH**/ ?>