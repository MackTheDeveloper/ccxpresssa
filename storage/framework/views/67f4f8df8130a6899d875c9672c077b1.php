...
<section class="content">
    ...
    <div class="box box-success">
        <div class="box-body">
            <?php echo e(Form::open(array('url' => '','class'=>'form-horizontal create-form','id'=>'openInvoiceForm','autocomplete'=>'off'))); ?>
        ...
        $('#openInvoiceForm').validate({
            ...
            submitHandler: function(form) {
                ...
                var toDate = $('.to-date-filter').val();
                    ...
                    var urlztnn = '<?php echo route("exportOpenInvoices"); ?>';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.custom', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/php/cargo/resources/views/reports/open-invoices.blade.php ENDPATH**/ ?>