...
<?php if ($flag == 'aeropost') { ?>
    <?php echo $__env->make('menus.aeropost-invoice', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php } ?>
<?php if ($flag == 'ccpack') { ?>
    <?php echo $__env->make('menus.ccpack-invoices', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
