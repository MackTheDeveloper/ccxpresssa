...
<section class="content-header">
    <h1><?php echo 'View Invoice'; ?><a style="float: right;padding-right: 10px" title="Click here to print" target="_blank" href="<?php echo e(route('printinvoice',[$invoice['id'],'cargo'])); ?>"><i class="fa fa-print"></i></a></h1>
</section>
<section class="content" style="font-family: sans-serif;">
    <div class="box box-success" style="width: 100%;margin: 0px auto;">
        <div class="box-body cargo-forms" style="color: #636b6f;overflow: hidden;">

            <h4 style="background: #ccc;padding:5px;font-weight:normal;width:100%;overflow: hidden;">
                <div style="float: left;width: 50%">Invoice : <?php echo e($invoice['bill_no']); ?></div>
            ...
            <div class="col-md-12" style="margin-top: 20px">
                ...
                <div class="sec2" style="float: left;width: 100%;margin-top: 20px">
                    <div style="width: 70%;float: left;">
                        <div class="" style="width: 100%;float: left;margin-bottom: 5px">
                    ...
                    <div style="float: right;width: 30%;float: left;">
                        <table style="border: 1px solid #ccc;width: 100%;font-family: sans-serif;color: #636b6f">
                            <tr style="border-collapse: collapse;height: 28px;text-align: center;">
                            ...
                            <tr style="height: 28px">
                                <td style="border-right: 1px solid #ccc;padding: 0px 10px">
                                    <div><?php echo date('d/m/Y', strtotime($invoice['date'])); ?></div>
                                </td>
                                <td style="pointer-events: none;opacity: 0.5;padding: 0px 10px">
                ...
                <div class="sec3" style="float: left;width: 100%;margin-top: 10px">
                    ...
                    <div style="width: 49%;float: left;margin-left: 25px;border: 1px solid #ccc;">
                ...
                <div class="sec4" style="float: left;width: 100%;margin-top: 10px">
                    <div class="">
                        <table CELLSPACING="0" CELLPADDING="0" style="border: 1px solid #ccc;width: 100%;font-family: sans-serif;color: #636b6f">
                ...
                <div class="sec5" style="float: left;width: 100%;margin-top: 10px">
                    <div class="">
                        <table CELLSPACING="0" CELLPADDING="0" style="border: 1px solid #ccc;width: 100%;font-family: sans-serif;color: #636b6f">
                            <thead>
                                <tr style="border-bottom: 1px solid #ccc;height: 39px;text-align: center;font-weight: bold;">
                                    <td style="width: 300px;padding:5px;border-right: 1px solid #ccc;border-bottom: 1px solid #ccc;text-align: center;font-weight: bold;font-size: 12px">Description</td>
                                    <td style="width: 100px;padding:5px;border-right: 1px solid #ccc;border-bottom: 1px solid #ccc;text-align: center;font-weight: bold;font-size: 12px">Qty</td>
                                    <td style="width: 100px;padding:5px;border-right: 1px solid #ccc;border-bottom: 1px solid #ccc;text-align: center;font-weight: bold;font-size: 12px">Unit Price</td>
                                    <td style="width: 100px;padding:5px;border-bottom: 1px solid #ccc;text-align: center;font-weight: bold;font-size: 12px">Total</td>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                ...
                                foreach ($dataInvoiceDetails as $k => $v) {    ?>
                                    <tr style="border-bottom: 1px solid #ccc;height: 39px;">
                                        <td style="padding:5px;text-align: center;border-right: 1px solid #ccc">
                                            <div style="text-align: left;padding-left: 10px"><?php echo $v->fees_name_desc; ?></div>
                                        </td>
                                        <td style="padding:5px;text-align: center;border-right: 1px solid #ccc">
                                            <div style="text-align: right;padding-right: 10px"><?php echo number_format($v->quantity, 2); ?></div>
                                        </td>
                                        <td style="padding:5px;text-align: center;border-right: 1px solid #ccc">
                                            <div style="text-align: right;padding-right: 10px"><?php echo number_format($v->unit_price, 2); ?></div>
                                        </td>
                                        <td style="padding:5px;text-align: center;">
                                            <div style="text-align: right;padding-right: 50px"><?php echo number_format($v->total_of_items, 2); ?></div>
                                        </td>
                                    </tr>
                                <?php  }  ?>
                            </tbody>
                ...
                <div style="float: left;width: 100%;margin-top: 10px">
                    ...
                    <div style="width: 50%;float: left;">
                        <div style="float: left;width: 100%;border-bottom: 1px solid #ccc;margin: 0px;padding: 5px">
                            <div style="float:left;width: 40%;text-align: left;">Sous Total</div>
                            <div style="float: left;width: 52%;margin-top: 0px;text-align: right;"><?php echo number_format($invoice['sub_total'], 2); ?></div>
                            <div style="float:left;margin-left: 5px"><?php $data = app('App\Currency')::getData($invoice['currency']);
                                                                        echo !empty($data->code) ? strtoupper($data->code) : "-"; ?></div>
                        </div>

                        <div style="float: left;width: 100%;border-bottom: 1px solid #ccc;margin: 0px;padding: 5px">
                            <div style="float:left;width: 40%;text-align: left;">TCA</div>
                            <div style="float: left;width: 52%;margin-top: 0px;text-align: right;">
                        ...
                        <div style="float: left;width: 100%;border-bottom: 1px solid #ccc;margin: 0px;padding: 5px">
                            <div style="float:left;width: 40%;text-align: left;">Total</div>
                            <div style="float: left;width: 52%;margin-top: 0px;text-align: right;">
                        ...
                        <div style="float: left;width: 100%;border-bottom: 1px solid #ccc;margin: 0px;padding: 5px">
                            <div style="float:left;width: 40%;text-align: left;">Paiements / Credits</div>
                            <div style="float: left;width: 52%;margin-top: 0px;text-align: right;">
                        ...
                        <div style="float: left;width: 100%;border-bottom: 1px solid #ccc;margin: 0px;padding: 5px">
                            <div style="float:left;width: 40%;text-align: left;">Solde du</div>
                            <div style="float: left;width: 52%;margin-top: 0px;text-align: right;">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.custom', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/php/cargo/resources/views/invoices/viewandprint.blade.php ENDPATH**/ ?>