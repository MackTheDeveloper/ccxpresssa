...
<script type="text/javascript">
	...
	function DatatableInitiate(fromDate = '', toDate = '', file_type = 'ups', typeimpexp = '') {
		$('#example').DataTable({
			...
			"scrollX": true,
			"ajax": {
				url: "<?php echo e(url('reports/listgetcommissionReport')); ?>", // json datasource
				data: function(d) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.custom', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/php/cargo/resources/views/reports/courier/commissionReport.blade.php ENDPATH**/ ?>