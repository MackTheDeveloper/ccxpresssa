...
<script type="text/javascript">
    ...
    function DatatableInitiate(fromDate = '', toDate = '') {
        ...
        var table = $('#example').DataTable({
            ...
            "ajax": {
                url: "<?php echo e(url('invoicepayment/listbydatatableserverside')); ?>", // json datasource
                "data": {
                    "flag": "<?php echo $flag; ?>",
                    "fromDate": fromDate,
                    "toDate": toDate
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.custom', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/php/cargo/resources/views/invoicepayments/index.blade.php ENDPATH**/ ?>