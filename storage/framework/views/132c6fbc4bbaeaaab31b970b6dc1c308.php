...
<?php echo $__env->make('layouts.included_css_js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <li class="dropdown">
                ...
                <ul role="menu" class="dropdown-menu">
                    ...
                    <li class="menu-item dropdown dropdown-submenu">
                        ...
                        <ul class="dropdown-menu sub-dpmenu">
                            <li>
                                <a href="<?php echo e(route('showStatementOfAccount')); ?>">Statement Of Accounts</a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('showPendingInvoices')); ?>">Pending Invoices</a>
                            </li>
                        </ul>
                    </li>
                    <li style="">
                        <a href="<?php echo e(route('showArAging')); ?>">A/R Aging</a>
                    </li>
                </ul>
            </li>
            <?php //} 
...
</style><?php /**PATH /var/www/html/php/cargo/resources/views/layouts/custom.blade.php ENDPATH**/ ?>