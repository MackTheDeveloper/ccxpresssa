<head>
    ...
    <link href="<?php echo e(asset('css/other.css')); ?>" rel="stylesheet">
    ...
    <link href="<?php echo e(asset('css/lobibox.min.css')); ?>" rel="stylesheet">
    ...
    <link href="<?php echo e(asset('css/jquery.inputpicker.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('css/daterangepicker.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('css/dataTables.jqueryui.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('css/bootstrap-datetimepicker.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('css/jquery.bxslider.min.css')); ?>" rel="stylesheet">
    ...
    <script src="<?php echo e(asset('js/dataTables.jqueryui.min.js')); ?>"></script>
    <script src="<?php echo e(asset('js/date-uk.js')); ?>"></script>
    <script src="<?php echo e(asset('js/jquery.formatCurrency-1.4.0.min.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('js/additional.min.js')); ?>"></script>
