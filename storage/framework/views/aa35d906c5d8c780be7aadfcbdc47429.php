    ...
    <div class="box box-success">
        <div class="box-body">
            ...
            <div style="display:none;float: right;width: 200px;margin: 0px;height: 35px;position: absolute;left: 70%;z-index: 111;top:22px">
                <a title="Click here to print" target="_blank" href="<?php echo e(route('nonBilledFilesReportsPDF')); ?>"><i class="fa fa-print btn btn-primary"></i></a>
            </div>
        ...
        $('#createInvoiceForm').validate({
            submitHandler: function(form) {
                ...
                if (submitButtonName == 'clsPrint') {
                    ...
                    var urlztnn = '<?php echo url("reports/nonBilledFilesReportsPDF"); ?>';
                    $.ajax({
                        url: urlztnn,
                        async: false,
                        type: 'POST',
                    ...
                    DatatableInitiate(fromDate, toDate, fileType, cargoType);
                }
            },
        });
    })

    function DatatableInitiate(fromDate = '', toDate = '', fileType = '', cargoType = 'Cargo') {
        var i = 1;
        var table = $('#example').DataTable({
            ...
            "ajax": {
                url: "<?php echo e(url('reports/listnonbilledfiles')); ?>", // json datasource
                data: function(d) {
                    d.fileType = fileType;
                    d.fromDate = fromDate;
                    d.toDate = toDate;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.custom', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/php/cargo/resources/views/reports/nonbilledfilesreport.blade.php ENDPATH**/ ?>