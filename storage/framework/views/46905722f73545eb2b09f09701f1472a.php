            ...
            <div style="float: left;width: 100%;border: 1px solid #ccc;">
                ...
                ?>
                    ...
                    <div style="background: #ceb33363;font-weight: bold;float: left;width: 100%;border-bottom: 1px solid #ccc;color:#000">
                        ...
                        <div style="padding: 8px;width: 6%;float: left;border-right: 1px solid #a59999;padding-left: 10px;">&nbsp;</div>
                        <div style="padding: 8px;width: 6%;float: left;border-right: 1px solid #a59999;padding-left: 10px;text-align:right"><?php echo e('USD'.' '.number_format($expensesumCurrentItem,2)); ?></div>
                        <div style="padding: 8px;width: 6%;float: left;border-right: 1px solid #a59999;padding-left: 10px;">&nbsp;</div>
                        ...
                        <div style="padding: 8px;width: 7%;float: left;border-right: 1px solid #a59999;padding-left: 10px;text-align:right"><?php echo e('USD'.' '.number_format($invoicesumCurrentItem,2)); ?></div>
                        <div style="padding: 8px;width: 7%;float: left;border-right: 1px solid #a59999;padding-left: 10px;">&nbsp;</div>
                        <div style="padding: 8px;width: 6%;float: left;border-right: 1px solid #a59999;padding-left: 10px;">&nbsp;</div>
                        <div style="text-align:right;font-weight:bold;padding: 8px;width: 6%;float: left;padding-left: 10px;color:<?php echo ($invoicesumCurrentItem - $expensesumCurrentItem) < 0 ? 'red' : 'green'; ?>"><?php echo e('USD'.' '.number_format($invoicesumCurrentItem-$expensesumCurrentItem,2)); ?></div>
                    </div>
                <?php } ?>
                <div style="background: #000;color:#fff;font-weight: bold;float: left;width: 100%;">
                    ...
                    <div style="padding: 8px;width: 13%;float: left;border-right: 1px solid #a59999;padding-left: 10px;">&nbsp;</div>
                    <div style="padding: 8px;width: 6%;float: left;border-right: 1px solid #a59999;padding-left: 10px;">&nbsp;</div>
                    <div style="padding: 8px;width: 6%;float: left;border-right: 1px solid #a59999;padding-left: 10px;text-align:right"><?php echo e('USD'.' '.number_format($expensesum,2)); ?></div>
                    <div style="padding: 8px;width: 6%;float: left;border-right: 1px solid #a59999;padding-left: 10px;">&nbsp;</div>
                    <div style="padding: 8px;width: 9%;float: left;border-right: 1px solid #a59999;padding-left: 10px;">&nbsp;</div>
                    <div style="padding: 8px;width: 13%;float: left;border-right: 1px solid #a59999;padding-left: 10px;">&nbsp;</div>
                    <div style="padding: 8px;width: 7%;float: left;border-right: 1px solid #a59999;padding-left: 10px;">&nbsp;</div>
                    <div style="padding: 8px;width: 7%;float: left;border-right: 1px solid #a59999;padding-left: 10px;text-align:right"><?php echo e('USD'.' '.number_format($invoicesum,2)); ?></div>
                    <div style="padding: 8px;width: 7%;float: left;border-right: 1px solid #a59999;padding-left: 10px;">&nbsp;</div>
                    <div style="padding: 8px;width: 6%;float: left;border-right: 1px solid #a59999;padding-left: 10px;">&nbsp;</div>
                    <div style="text-align:right;font-weight:bold;padding: 8px;width: 6%;float: left;padding-left: 10px;color:<?php echo ($invoicesum - $expensesum) < 0 ? 'red' : 'green'; ?>"><?php echo e('USD'.' '.number_format($invoicesum-$expensesum,2)); ?></div>
                </div>
            </div>
        </div>
    </td>
</tr><?php /**PATH /var/www/html/php/cargo/resources/views/reports/getaccountpayablereportdata.blade.php ENDPATH**/ ?>