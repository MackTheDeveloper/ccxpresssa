...
<section class="content">
    ...
    <div class="box box-success">
        <div class="box-body">
            ...
            ?>
            <?php echo e(Form::open(array('url' => $actionUrl,'class'=>'form-horizontal create-form create-form-expenenseinbasiccargo','id'=>'createExpenseForm','autocomplete'=>'off'))); ?>
            ...
            <div class="expensemaincontainer">
                <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                        <div class="form-group <?php echo e($errors->has('voucher_number') ? 'has-error' :''); ?>">
                            <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <div class="col-md-4">
                        <div class="form-group <?php echo e($errors->has('cargo_id') ? 'has-error' :''); ?>">
                            <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                        <div class="form-group <?php echo e($errors->has('consignee') ? 'has-error' :''); ?>">
                            <div class="col-md-12">
                    ...
                    <?php if (!empty($dataCargo) && $dataCargo->cargo_operation_type != 3) { ?>
                        <div class="col-md-4 shipperdiv">
                            <div class="form-group <?php echo e($errors->has('shipper') ? 'has-error' :''); ?>">
                                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                        <div class="form-group <?php echo e($errors->has('cash_credit_account') ? 'has-error' :''); ?>">
                            <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <div class="col-md-4">
                        <div class="form-group <?php echo e($errors->has('cashier_id') ? 'has-error' :''); ?>">
                            <div class="col-md-12 required">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var urlzte = '<?php echo e(url("vendors/getvendordata")); ?>';
        $.ajax({
            async: false,
            url: urlzte,
            dataType: "json",
    ...
    function getExpenseTypeDesc(id){
        ...
        if (costId != '') {
            ...
            var urlzt = '<?php echo e(url("costs/getcostdata")); ?>';
            $.ajax({
                url: urlzt,
                dataType: "json",
                type: 'POST',
