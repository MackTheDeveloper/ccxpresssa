...
<script type="text/javascript">
    ...
    function DatatableInitiate(moduleInvoice = 'Cargo', clientId = '<?php echo $clientId; ?>', fromDate = '', toDate = '') {
        ...
        var table = $('#example').DataTable({
            ...
            "ajax": {
                url: "<?php echo e(url('reports/listgetdueinvoicesofclient')); ?>", // json datasource
                data: function(d) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.custom', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/php/cargo/resources/views/reports/getdueinvoicesofclient.blade.php ENDPATH**/ ?>