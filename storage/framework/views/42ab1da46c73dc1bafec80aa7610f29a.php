...
<?php if ($flagModule == 'ccpack') { ?>
    <?php echo $__env->make('menus.ccpack-invoices', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php } ?>
<?php $__env->stopSection(); ?>
    ...
    <div class="box box-success" style="float: left;">
        <div class="box-body">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-4">
                    <div class="form-group <?php echo e($errors->has('invoice_id') ? 'has-error' :''); ?>">
            ...
            <div class="col-md-12" style="margin-top: 25px;">
                <div class="col-md-4">
                    <div class="form-group <?php echo e($errors->has('payment_via') ? 'has-error' :''); ?>">
                ...
                <div class="col-md-8">
                    <div class="form-group <?php echo e($errors->has('payment_via_note') ? 'has-error' :''); ?>">
            ...
            <div class="col-md-12">
                ...
                <div class="form-group col-md-12 btm-sub">
                    ...
                    <a class="btn btn-danger" href="<?php echo e(route('invoicepaymentslisting', [$flagModule])); ?>" title="">Cancel</a>
                </div>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.custom', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/php/cargo/resources/views/invoicepayments/edit.blade.php ENDPATH**/ ?>