                ...
                <div style="width:100%;float: left;">
                    ...
                    <div style="float: left;width: 100%">
                        ...
                        <div class="mblock" style="float:left;width: 24%;text-align: center;background: #e2e2e2;margin-right: 1%;padding: 10px 0px 10px 0px;">
                            ...
                            <span style="width: 100%;float: left;"><?php echo e(Html::image('images/Dossiers.png', 'alt text', array('class' => 'css-class'))); ?></span>
                        </div>
                        </a>
                        <?php } ?>
                        ...
                        <div class="mblock" style="float:left;width: 24%;text-align: center;background: #e2e2e2;margin-right: 1%;padding: 10px 0px 10px 0px;">
                            ...
                            <span style="width: 100%;float: left;"><?php echo e(Html::image('images/File-expense.png', 'alt text', array('class' => 'css-class'))); ?></span>
                        </div>
                        </a>
                        <?php } ?>
                        ...
                        <div class="mblock" style="float:left;width: 24%;text-align: center;background: #e2e2e2;margin-right: 1%;padding: 10px 0px 10px 0px;">
                            ...
                            <span style="width: 100%;float: left;"><?php echo e(Html::image('images/Facturation.png', 'alt text', array('class' => 'css-class'))); ?></span>
                        </div>
                        </a>
                        <?php } ?>
                        ...
                        <div class="mblock" style="float:left;width: 25%;text-align: center;background: #e2e2e2;padding: 10px 0px 10px 0px;">
                            ...
                            <span style="width: 100%;float: left;"><?php echo e(Html::image('images/Warehouse.png', 'alt text', array('class' => 'css-class'))); ?></span>
                        </div>
                        </a>
                        <?php } ?>
                    </div>
        		...
        		<div style="width:100%;float: left;margin-right: 4%;margin-top: 20px">
        			...
        			<div style="float: left;width: 100%">
        				...
        				<div class="mblock" style="float:left;width: 25%;text-align: center;background: #e2e2e2;padding: 10px 0px 10px 0px;">
        					...
        					<span style="width: 100%;float: left;"><?php echo e(Html::image('images/Customs.png', 'alt text', array('class' => 'css-class'))); ?></span>
        				</div>
                        </a>
                        <?php } ?>
        			</div>
        		...
        		<div style="width:100%;float: left;margin-right: 4%">
        			...
        			<div style="float: left;width: 100%">
        				...
        				<div class="mblock" style="float:left;width: 24%;text-align: center;background: #e2e2e2;margin-right: 1%;padding: 10px 0px 10px 0px;">
        					...
        					<span style="width: 100%;float: left;"><?php echo e(Html::image('images/Client.png', 'alt text', array('class' => 'css-class'))); ?></span>
        				</div>
                        </a>
                        <?php } ?>
        				...
        				<div class="mblock" style="float:left;width: 24%;text-align: center;background: #e2e2e2;margin-right: 1%;padding: 10px 0px 10px 0px;">
        					...
        					<span style="width: 100%;float: left;"><?php echo e(Html::image('images/Vendors.png', 'alt text', array('class' => 'css-class'))); ?></span>
        				</div>
                        </a>
                        <?php } ?>
        				...
        				<div class="mblock" style="float:left;width: 24%;text-align: center;background: #e2e2e2;margin-right: 1%;padding: 10px 0px 10px 0px;">
        					...
        					<span style="width: 100%;float: left;"><?php echo e(Html::image('images/Petty-cash.png', 'alt text', array('class' => 'css-class'))); ?></span>
        				</div>
                        </a>
                        <?php } ?>
        				...
        				<div class="mblock" style="float:left;width: 25%;text-align: center;background: #e2e2e2;padding: 10px 0px 10px 0px;">
        					...
        					<span style="width: 100%;float: left;"><?php echo e(Html::image('images/Deposit.png', 'alt text', array('class' => 'css-class'))); ?></span>
        				</div>
                        </a>
                        <?php } ?>
        			</div>
        		...
        		<div style="width:100%;float: left;margin-top: 20px">
        			...
        			<div style="float: left;width: 100%">
        				...
        				<div class="mblock" style="float:left;width: 24%;text-align: center;background: #e2e2e2;margin-right: 1%;padding: 10px 0px 10px 0px;">
        					...
        					<span style="width: 100%;float: left;"><?php echo e(Html::image('images/Cash-bank.png', 'alt text', array('class' => 'css-class'))); ?></span>
        				</div>
                        </a>
                        <?php } ?>
        				...
        				<div class="mblock" style="float:left;width: 24%;text-align: center;background: #e2e2e2;margin-right: 1%;padding: 10px 0px 10px 0px;">
        					...
        					<span style="width: 100%;float: left;"><?php echo e(Html::image('images/Missing-invoice.png', 'alt text', array('class' => 'css-class'))); ?></span>
        				</div>
                        </a>
                        <?php } ?>
        				...
        				<div class="mblock" style="float:left;width: 24%;text-align: center;background: #e2e2e2;margin-right: 1%;padding: 10px 0px 10px 0px;">
        					...
        					<span style="width: 100%;float: left;"><?php echo e(Html::image('images/Pending-invoice.png', 'alt text', array('class' => 'css-class'))); ?></span>
        				</div>
                        </a>
                        <?php } ?>
