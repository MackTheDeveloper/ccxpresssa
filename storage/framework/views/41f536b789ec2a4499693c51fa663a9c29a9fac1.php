...
<?php } ?>
<a class="<?php echo $currentRoute == "viewall" ? "activeMenu" : ""; ?>" style="margin-left: 10px;display: none" href="<?php echo e(route('viewall')); ?>"><i style="color: #fff" class="fa fa-list fa-2x"></i><span class="menuname">View All Files</span></a>