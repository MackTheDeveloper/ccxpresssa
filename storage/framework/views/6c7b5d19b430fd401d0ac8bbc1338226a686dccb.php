                    <?php echo e(Form::open(array('url' => $actionUrl,'class'=>'form-horizontal create-form','id'=>'w1','autocomplete'=>'off'))); ?>
                    ...
                    <div class="col-md-12">
                        <div class="col-md-6 flagconsolmn">
                            <div class="form-group <?php echo e($errors->has('consolidate_flag') ? 'has-error' :''); ?>">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-6">
                            <div class="form-group <?php echo e($errors->has('flag_package_container') ? 'has-error' :''); ?>">
                    ...
                    <div class="col-md-12 packagediv" style="margin-left: 1%;">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="row">
                                    <div class="col-md-3 form-group <?php echo e($errors->has('pweight') ? 'has-error' :''); ?>">
                            ...
                            <div class="col-md-4">
                                <div class="row">
                                    <div class="col-md-3 form-group <?php echo e($errors->has('pvolume') ? 'has-error' :''); ?>">
                            ...
                            <div class="col-md-4">
                                <div class="row">
                                    <div class="col-md-3 form-group <?php echo e($errors->has('ppieces') ? 'has-error' :''); ?>">
                    ...
                    <div class="col-md-12 containerdiv" style="display: none">
                        <div class="col-md-4">
                            <div class="form-group <?php echo e($errors->has('no_of_container') ? 'has-error' :''); ?>">
