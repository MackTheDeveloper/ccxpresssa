...
<script type="text/javascript">
    ...
    function DatatableInitiate(fromDate = '', toDate = '') {
        $('#example').DataTable({
            ...
            "scrollX": true,
            "ajax": {
                url: "<?php echo e(url('aeropostinvoices/listbydatatableserverside')); ?>", // json datasource
                "data": {
                    "fromDate": fromDate,
                    "toDate": toDate
                },
            ...
            "createdRow": function(row, data, index) {
                ...
                var url = '<?php echo url("aeropostinvoices/checkoperationfordatatableserverside"); ?>';
                $.ajax({
                    url: url,
                    type: 'POST',
                    dataType: 'json',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.custom', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/php/cargo/resources/views/aeropost-invoices/index.blade.php ENDPATH**/ ?>