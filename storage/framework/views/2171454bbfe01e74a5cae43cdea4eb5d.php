...
<section class="content">
    ...
    <div class="box box-success">
        <div class="box-body">
            <?php echo e(Form::open(array('url' => '','class'=>'form-horizontal create-form','id'=>'arAgingForm','autocomplete'=>'off'))); ?>
            ...
            <div class="row" style="margin-bottom:20px">
                <div class="filterout col-md-12">
                    ...
                    <div class="to-date-filter-div filterout col-md-2">
                        <input type="text" value="<?php echo e(date('d-m-Y')); ?>" name="to_date_filter" placeholder=" -- To Date" class="form-control datepicker to-date-filter">
                    </div>
                    <div class="col-md-2">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.custom', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/php/cargo/resources/views/reports/ar-aging.blade.php ENDPATH**/ ?>