<?php echo e(Form::open(array('url' => $actionUrl,'class'=>'form-horizontal create-form','id'=>'createImportforms','autocomplete'=>'off','enctype'=>"multipart/form-data"))); ?>

<?php echo e(csrf_field()); ?>

<input type="hidden" name="ups_operation_type" value="1">
<?php if ($model->id) { ?>
<div class="col-md-12">
    <div class="col-md-6">
...
<div class="col-md-12">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-md-8">
                <?php echo Form::text('consignee_name', Config::get('app.upsMasterImport')['consignee'], ['class' => 'form-control fconsignee_name', 'placeholder' => 'Enter Consignee Name']); ?>
            </div>
        </div>
    </div>
</div>
<?php $upsMasterImportConsignee = app('App\UpsMaster')->getConsigneeShipper(Config::get('app.upsMasterImport')['consignee']); ?>
<div class="col-md-12">
    <div class="col-md-6">
        <div class="form-group">
            <?php echo Form::label('consignee_address', 'Consignee Address :', ['class' => ' control-label']); ?>
            <div class="col-md-8">
                <?php echo Form::textarea('consignee_address', $upsMasterImportConsignee->company_address, ['class' => 'form-control', 'placeholder' => 'Enter Consignee Address', 'rows' => 2]); ?>
            </div>
        </div>
    </div>
</div>
<div class="col-md-12">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-md-8">
                <?php echo Form::text('shipper_name', Config::get('app.upsMasterImport')['shipper'], ['class' => 'form-control', 'placeholder' => 'Enter Shipper Name']); ?>
            </div>
        </div>
    </div>
    <div class="col-md-6">
...
</script><?php /**PATH /var/www/html/php/cargo/resources/views/ups-master/importFile.blade.php ENDPATH**/ ?>