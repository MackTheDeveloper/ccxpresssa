...
<a class="<?php echo $currentRoute == "housefileexpenses" ? "activeMenu" : ""; ?>" style="margin-left: 10px" href="<?php echo e(route('housefileexpenses')); ?>"><i style="color: #fff" class="fa fa-list fa-2x"></i><span class="menuname">House File Expense Listing</span></a><?php /**PATH /var/www/html/php/cargo/resources/views/menus/cargo-expense.blade.php ENDPATH**/ ?>