...
<?php echo $__env->make('menus.ups-invoice', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
                ...
                <div class="col-md-12" style="margin-top: 20px">
                    <div class="sec1" style="float: left;width: 100%">
                        <div class="d1 col-md-2">
                            <?php echo e(Html::image('images/invoice_logo.png', 'alt text', array('class' => 'css-class'))); ?>
