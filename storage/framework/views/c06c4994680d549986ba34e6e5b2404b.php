...
<script type="text/javascript">
        ...
        $('#createInvoiceForm').validate({
            submitHandler: function(form) {
                ...
                if (submitButtonName == 'clsPrint') {
                    ...
                    var urlztnn = '<?php echo url("reports/filesWithExpenseNoInvoicesPDF"); ?>';
                    $.ajax({
                        url: urlztnn,
                        async: false,
                        type: 'POST',
    ...
    function DatatableInitiate(fromDate = '', toDate = '', fileType = '') {
        ...
        var table = $('#example').DataTable({
            ...
            "ajax": {
                url: "<?php echo e(url('reports/listfilesWithExpenseNoInvoices')); ?>", // json datasource
                data: function(d) {
                    d.fileType = fileType;
                    d.fromDate = fromDate;
                    d.toDate = toDate;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.custom', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/php/cargo/resources/views/reports/filesWithExpenseNoInvoices.blade.php ENDPATH**/ ?>