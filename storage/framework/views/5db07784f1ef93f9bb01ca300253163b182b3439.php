                    <?php echo e(Form::open(array('url' => $actionUrl,'class'=>'form-horizontal create-form','id'=>'w2','autocomplete'=>'off'))); ?>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group <?php echo e($errors->has('no_of_pieces') ? 'has-error' :''); ?>">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-6">
                            <div class="form-group <?php echo e($errors->has('sent_on') ? 'has-error' :''); ?>">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-12">
                            <div class="form-group <?php echo e($errors->has('sent_by') ? 'has-error' :''); ?>">
