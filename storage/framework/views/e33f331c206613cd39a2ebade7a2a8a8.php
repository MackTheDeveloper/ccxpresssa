...
<script type="text/javascript">
    ...
    function DatatableInitiate(fromDate = '', toDate = '') {
        $('#example').DataTable({
            ...
            "scrollX": true,
            "ajax": {
                url: "<?php echo e(url('upsinvoice/listbydatatableserverside')); ?>", // json datasource
                "data": {
                    "fromDate": fromDate,
                    "toDate": toDate
                },
            ...
            "createdRow": function(row, data, index) {
                ...
                var url = '<?php echo url("upsinvoice/checkoperationfordatatableserverside"); ?>';
                $.ajax({
                    url: url,
                    type: 'POST',
                    dataType: 'json',
                    ...
                    success: function(dataR) {
                        if (dataR.deleted == '0') {
                            ...
                            if (dataR.payment_status == 'Paid' || dataR.total == '0.00')
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.custom', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/php/cargo/resources/views/upsinvoices/index.blade.php ENDPATH**/ ?>