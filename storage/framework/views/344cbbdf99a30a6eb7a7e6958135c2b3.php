    ...
    <div class="box box-success" style="float: left;">
        <div class="box-body">
            ...
            <div class="col-md-12">
                ...
                <input type="hidden" value="<?php echo $flagModule; ?>" id="flagModule" name="flagModule">
            ...
            <div class="col-md-12">
                ...
                <div class="form-group col-md-12 btm-sub">
                    ...
                    <a class="btn btn-danger" href="<?php echo e(route('invoicepaymentslisting', ['cargo'])); ?>" title="">Cancel</a>
                </div>
            </div>
    ...
    $(document).ready(function() {
        ...
        $('#createInvoiceForm').validate({
            submitHandler: function(form) {
                ...
                var urlztnn = '<?php echo url("invoicepayment/store"); ?>';
                $.ajax({
                    url: urlztnn,
                    type: 'POST',
                    data: formData,
                    success: function(data) {
                        ...
                        window.location.href = "<?php echo route('invoicepaymentslisting', ['cargo']); ?>";
                    }
                })
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.custom', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/php/cargo/resources/views/invoicepayments/form.blade.php ENDPATH**/ ?>