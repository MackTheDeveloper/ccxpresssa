        ...
        <div class="box box-success" style="width: 100%;margin: 0px auto;">
            <div class="box-body cargo-forms" style="color: #000">
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td style="border-bottom:1px solid hsl(0, 0%, 86%);border-right:1px solid hsl(0, 0%, 86%); padding:5px;font-family: Asap, sans-serif;font-size:14px; border-collapse: collapse;text-align: center;"><?php echo e('#'.$items->fileNumber.', '.$items->trackingNumber); ?></td>
                                    <td style="border-bottom:1px solid hsl(0, 0%, 86%);border-right:1px solid hsl(0, 0%, 86%); padding:5px;font-family: Asap, sans-serif;font-size:14px; border-collapse: collapse;text-align: center;"><?php echo e('#'.$items->bill_no); ?></td>
                                    <td style="border-bottom:1px solid hsl(0, 0%, 86%);border-right:1px solid hsl(0, 0%, 86%); padding:5px;font-family: Asap, sans-serif;font-size:14px; border-collapse: collapse;text-align: right;"><?php echo e(number_format($items->totalAmount,2)); ?></td>
                                    <td style="border-bottom:1px solid hsl(0, 0%, 86%);border-right:1px solid hsl(0, 0%, 86%); padding:5px;font-family: Asap, sans-serif;font-size:14px; border-collapse: collapse;text-align: right;"><?php echo e(number_format($items->totalDue,2)); ?></td>
                                </tr>
                        <?php }
                        } ?>
                    </tbody>
                ...
                <div style="width:40%;float:right;margin-top:10px;">
                    ...
                    <div style="width: 59%;float:left;text-align: right;"><?php echo e($currencyData->code.' '.number_format($allTotalDue,2)); ?></div>
                </div>
            </div>
        </div>
    </section>
...
</html><?php /**PATH /var/www/html/php/cargo/resources/views/reports/printDueInvoices.blade.php ENDPATH**/ ?>