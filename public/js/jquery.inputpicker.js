...
(function(factory) {
    ...
    function _loadData(input, data, func) {
        ...
        // By manish - Modified below statement
        input.addClass('loading').prop('disabled', false);
        // By manish - Modified
    ...
    function _setValueForMultiple(input, value) {
        ...
        for(var i = 0; i < new_data.length; i++){
            var d = new_data[i];
            $("<li class=\"inputpicker-element\" data-value=\"" + d[fieldValue] + "\"><span>" + d[fieldText] + "</span></li>").insertBefore(li_input);
        }
    ...
    function _eventKeyUp(e) {
        ...
        if ( _set(input, 'url')){
            ...
            // By manish - Added below statement
