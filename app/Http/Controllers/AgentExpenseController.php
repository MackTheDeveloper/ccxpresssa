...
class AgentExpenseController extends Controller
{
    ...
    public function index()
    {
        ...
        $cargoExpenseDataByVoucher = DB::table('expenses')
            ...
            ->get();
        return view("agent-role.expenses.index", ['cargoExpenseDataByVoucher' => $cargoExpenseDataByVoucher]);
    }

    public function create($flag, $cargoId = null, $flagFromWhere = null, $gauranteeId = null)
    {
        ...
        return view('agent-role.expenses._form', ['model' => $model, 'billingParty' => $billingParty, 'flag' => $flag, 'dataBillingItems' => $dataBillingItems, 'dataAwbNos' => $dataAwbNos, 'dataFileNumber' => $dataFileNumber, 'voucherNo' => $voucherNo, 'dataPaidTo' => $dataPaidTo, 'dataCost' => $dataCost, 'cargoId' => $cargoId, 'flagFromWhere' => $flagFromWhere, 'allUsers' => $allUsers, 'cashCredit' => $cashCredit, 'currency' => $currency, 'adminManagersRole' => $adminManagersRole, 'adminManagersUsers' => $adminManagersUsers, 'cashier' => $cashier, 'guaranteeData' => $guaranteeData]);
    }
