    ...
    <div class="box box-success">
        <div class="box-body">
            ...
            <div style="display:none;float: right;width: 200px;margin: 0px;height: 35px;position: absolute;left: 70%;z-index: 111;top:22px">
                <a title="Click here to print" target="_blank" href="{{ route('warehousereportpdf') }}"><i class="fa fa-print btn btn-primary"></i></a>
            </div>
...
<script type="text/javascript">
    ...
    function DatatableInitiate(fromDate = '', toDate = '', fileType = '') {
        ...
        var table = $('#example').DataTable({
            ...
            "ajax": {
                url: "{{url('reports/listwarehousereport')}}", // json datasource
                data: function(d) {
                    d.fileType = fileType;
                    d.fromDate = fromDate;
                    d.toDate = toDate;
