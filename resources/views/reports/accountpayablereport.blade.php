...
<section class="content">
    ...
    @endif
    @if(Session::has('flash_message_disbursement'))
    <div class="alert alert-success flash-success">
        {{ Session::get('flash_message_disbursement') }}
    </div>
    @endif
    ...
    <div class="box box-success">
        <div class="box-body">
            ...
            <?php if ($permissionApprove) { ?>
                ...
                {{ Form::open(array('url' => $actionUrl,'class'=>'','style' => 'width: auto;float: right;margin-left: 20px;','id'=>'approveexpenseinaccountpayablereport','autocomplete'=>'off')) }}
                {{ csrf_field() }}
                <div class="row" style="margin-bottom:20px">
                ...
                {{ Form::close() }}
            <?php } ?>
            <div style="float: right"><span>Total Disbursement: </span><span style="margin-right: 15px" class="totalDisbursement">0.00</span><button style="" id="btnApDisbursement" class="btn btn-success btnApDisbursement" value="{{route('ap-disbursement')}}">Disbursement</button></div>
...
<script type="text/javascript">
    ...
    function DatatableInitiate(fromDate = '', toDate = '', modules = 'Cargo', vendors = '', duration = '') {
        ...
        var table = $('#example').DataTable({
            ...
            "ajax": {
                url: "{{url('reports/listaccountpayablereport')}}", // json datasource
                data: function(d) {
                    d.fromDate = fromDate;
                    d.toDate = toDate;
                    d.modules = modules;
