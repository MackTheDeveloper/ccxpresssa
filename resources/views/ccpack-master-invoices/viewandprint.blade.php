...
<section class="content-header">
    <h1><?php echo 'View Invoice'; ?><a style="float: right;padding-right: 10px" title="Click here to print" target="_blank" href="{{ route('printinvoice',[$invoice['id'],'ccpackMaster']) }}"><i class="fa fa-print"></i></a></h1>
</section>
