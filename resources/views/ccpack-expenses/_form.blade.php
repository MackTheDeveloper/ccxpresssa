...
@section('title')
<?php echo $model->id ? 'Update CCpack File Expense Request' : 'Add CCpack File Expense Request'; ?>
@stop
...
<section class="content-header">
    <h1><?php echo $model->id ? 'Update CCpack File Expense Request' : 'Add CCpack File Expense Request'; ?></h1>
</section>
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                        <div class="form-group {{ $errors->has('file_number') ? 'has-error' :'' }}">
                            ...
                            <div class="col-md-12">
                                <?php echo Form::select('file_number', $dataFileNumber, $ccpackId, ['class' => 'form-control selectpicker ffilenumber', 'data-live-search' => 'true', 'placeholder' => 'Select ...']); ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    <div class="col-md-4">
                        <div class="form-group {{ $errors->has('ccpack_id') ? 'has-error' :'' }}">
                            ...
                            <div class="col-md-12" style="pointer-events: none;opacity: 0.5">
                                <?php echo Form::select('ccpack_id', $dataAwbNos, $ccpackId, ['class' => 'form-control fawb', 'placeholder' => 'Select ...']); ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12" style="text-align: center;">
                    ...
                    <div class="form-group" style="padding-top: 28px;">
                        ...
                        if ($flagFromWhere == 'flagFromListing')
                            $cancleRoute = route('ccpack');
                        elseif ($flagFromWhere == 'flagFromView')
                            $cancleRoute = route('viewdetailsccpack', [$ccpackId]);
                        else
    ...
    $(document).ready(function() {
        ...
        $('#createExpenseForm').validate({
            ...
            submitHandler: function(form) {
                ...
                var urlz = '<?php echo url("ccpack/expense/store"); ?>';
                $.ajax({
                    url: urlz,
                    async: false,
                    type: 'POST',
                    ...
                    success: function(data) {
                        ...
                        <?php if ($flagFromWhere == 'flagFromView') { ?>
                            window.location.href = '<?php echo route('viewdetailsccpack', [$ccpackId]) ?>';
                        <?php } else { ?>
                            window.location.href = '<?php echo route("ccpackexpenses") ?>';
                        <?php } ?>
                ...
                if (submitButtonName == 'CreateExpenseFormButtonSaveNext') {
                    window.location.href = '<?php echo route("ccpackexpensecreate") ?>';
                } else {
