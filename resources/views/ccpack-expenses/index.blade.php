...
<section class="content-header">
    <h1>CCpack File Expense Listing</h1>
</section>
        ...
        <div class="box-body">
            <div class="row" style="margin-bottom:20px">
                ...
                <div style="float: right;margin-right: 10px;height: 35px;z-index: 111;top: 18px;">
                    <a style="float:left;margin-right: 10px;" title="Click here to print" target="_blank" href="{{ route('printallccpackexpense',['all']) }}"><i style="padding:10px" class="fa fa-print btn btn-primary"></i></a>
                    ...
                    <input type="hidden" name="flag" value="ccpackExpense">
...
<script type="text/javascript">
    ...
    function DatatableInitiate(status = '', expenseType = '') {
        ...
        $('#example').DataTable({
            ...
            "ajax": {
                url: "{{url('ccpack/expense/listbydatatableserverside')}}", // json datasource
                data: function(d) {
                    d.status = status;
                            ...
                            success: function(data) {
                                if (data.deleted == '0') {
                                    <?php if (checkloggedinuserdata() == 'Cashier') { ?>
                                        var editLink = '<?php echo url("ccpack/getprintviewsingleccpackexpensecashier"); ?>';
                                        editLink += '/' + expenseId + '/' + data.ccpack_id + '/fromNotification';
                                    <?php } else { ?>
                                        var editLink = '<?php echo url("ccpack/expense/edit"); ?>';
