...
<?php if ($permissionCargoExpensesAdd) { ?>
    <a class="<?php echo $currentRoute == "createexpenseusingawl" ? "activeMenu" : ""; ?>" href="{{ route('createexpenseusingawl','cargo') }}"><i style="color: #fff" class="fa fa-plus-circle fa-2x"></i><span class="menuname">Add Cargo File Expense Request</span></a>

    <a class="<?php echo $currentRoute == "createhousefileexpense" ? "activeMenu" : ""; ?>" href="{{ route('createhousefileexpense') }}"><i style="color: #fff" class="fa fa-plus-circle fa-2x"></i><span class="menuname">Add House File Expense Request</span></a>
