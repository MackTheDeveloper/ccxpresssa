...
<section class="content-header">
    <h1>Aeropost Master Invoices</h1>
</section>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.customButtonInGridinvoicestatus').click(function() {
            ...
            var aeropostId = $(this).data('aeropostid');
            var thiz = $(this);
            $.ajaxSetup({
                headers: {
    ...
    function DatatableInitiate(fromDate = '', toDate = '') {
        $('#example').DataTable({
            ...
            "scrollX": true,
            "ajax": {
                url: "{{url('aeropost-master/invoice/listbydatatableserverside')}}", // json datasource
                "data": {
                    "fromDate": fromDate,
                    "toDate": toDate
                },
            ...
            "createdRow": function(row, data, index) {
                ...
                var url = '<?php echo url("aeropost-master/invoice/checkoperationfordatatableserverside"); ?>';
                $.ajax({
                    url: url,
                    type: 'POST',
                    dataType: 'json',
                    data: {
                        'invoiceId': invoiceId,
                        'flag': 'getMasterAeropostInvoiceData'
                    },
                    success: function(dataR) {
                        if (dataR.deleted == '0') {
                            var editLink = '<?php echo url("aeropost-master/invoice/viewaeropostmasterinvoicedetails"); ?>';
                            editLink += '/' + invoiceId;
