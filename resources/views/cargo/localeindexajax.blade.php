...
<div class="box-body">
    <select id="cargolisting" class="form-control">
        ...
        <option selected="" value="3">Locale Files</option>
    </select>
    ...
    <table id="example" class="display nowrap" style="width:100%;float: left;">
        ...
        <tbody>
            ...
            ?>
            <tr style="<?php echo $assignedCss; ?>" data-editlink="{{ route('viewcargo',[$cargos->id,'3']) }}" id="<?php echo $cargos->id; ?>" class="edit-row">
                                ...
                                ?>
                                    <li>
                                        <a href="{{ route('createexpenseusingawl',['cargo',$cargos->id,'flagFromListing']) }}">Add Expense
                                            ...
                                            if ($countPending != 0) {
                                                $csStyle = '';
                                            } ?><span style="<?php echo $csStyle; ?>" class="pendingexpense"><?php echo $countPending; ?></span></a>
