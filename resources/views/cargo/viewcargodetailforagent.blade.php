...
<section class="content-header" style="    display: block;position: relative;top: 0px;">
	<h1 style="font-size: 20px !important;margin-top: 50px;font-weight: 600;"><?php echo 'Cargo ( '.($model->cargo_operation_type == 1 ? 'Import' : ($model->cargo_operation_type == 2 ? 'Export' : 'Locale')).' - '.$model->awb_bl_no.' ) '; ?></h1>
</section>
		...
		<div class="box-body">
			...
			<div class="detail-container">
				...
				<div style="float: left;width: 50%; margin-bottom: 10px;">
					...
					<span class="viewblk2"><?php echo !empty($model->consignee_name) ? App\Ups::getConsigneeName($model->shipper_name) : '-' ?></span>
				</div>
				<div style="float: left;width: 50%; margin-bottom: 10px;">
				...
				<div style="float: left;width: 50%; margin-bottom: 10px;">
					<span class="viewblk1">No. of units : </span>
					<span class="viewblk2"><?php echo !empty($model->no_of_units) ? $model->no_of_units : '-'; ?></span>
				</div>
				<div style="float: left;width: 50%; margin-bottom: 10px;">
					<span class="viewblk1">Explications : </span>
					<span class="viewblk2"><?php echo !empty($model->information) ? $model->information : '-'; ?></span>
				...
				<div style="float: left;width: 50%; margin-bottom: 10px;">
					<span class="viewblk1">Nature du service : </span>
					<span class="viewblk2"><?php echo !empty($model->nature_of_goods) ? $model->nature_of_goods : '-'; ?></span>
				</div>
	        ...
	        <div class="col-md-12">
	                ...
	                <?php } ?>
	                <div class="form-group col-md-3 btm-sub">
	                	<div class="col-md-12">
