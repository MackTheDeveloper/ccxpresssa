...
@section('title')
<?php echo $model->id ? 'Update Administration Expense' : 'Add Administration Expense'; ?>
@stop
...
<?php
if (!empty($model->id)) {
    $counter = App\OtherExpensesDetails::where('expense_id', $model->id)->where('deleted', '0')->count();
    if ($counter == 0)
        $counter = 1;
} else {
    $counter = 0;
...
<section class="content-header">
    <h1><?php echo $model->id ? 'Update Administration Expense' : 'Add Administration Expense'; ?></h1>
</section>
<section class="content">
    ...
    <div class="box box-success">
        <div class="box-body">
            ...
            <?php
            $actionUrl = route('updateotherexpense', [$model->id]);
            ?>
            ...
            {{ csrf_field() }}
            <input type="hidden" class="" name="flagFrom" value="<?php echo $flagFrom ?>">
            ...
            <div class="expensemaincontainer">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-4">
                            <div class="form-group {{ $errors->has('expense_request') ? 'has-error' :'' }}">
                                ...
                                <div class="col-md-12">
                                    <?php if (isset($model->id) && !empty($model->request_by)) { ?>
                                ...
                                <tbody>
                                    <?php if (empty($dataExpenseDetails)) { ?>
                                        <tr id="0">
                                            ...
                                            <td><?php echo Form::textarea('expenseDetails[description][0]', '', ['class' => 'form-control cvalidation description fdescription', 'id' => 'description-0', 'rows' => 1]); ?></td>
                                        ...
                                        foreach ($dataExpenseDetails as $k => $v) {
                                            ...
                                            <tr id="<?php echo $i; ?>">
                                                ...
                                                <td><?php echo Form::textarea("expenseDetails[description][$i]", $v->description, ['class' => 'form-control cvalidation description fdescription', 'id' => "description-$i", 'rows' => 1]); ?></td>
                ...
                <div class="col-md-12" style="text-align: center;">
                    ...
                    <div class="form-group" style="padding-top: 28px;">
                        ...
                        <?php
                        $cancleRoute = route('otherexpenses', $flagFrom);
                        ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('.allcontainer').on("click", ".addmoreexpense", function(e) {
            ...
            var urlzte = '<?php echo url("otherexpense/addmoreotherexpense"); ?>';
            $.ajax({
                url: urlzte,
                type: 'POST',
                data: {
