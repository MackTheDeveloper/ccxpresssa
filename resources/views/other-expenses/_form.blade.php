...
<?php
/*  if (app('App\User')->checkUserByRole() == 'Cashier' || app('App\User')->checkUserByRole() == 'Caissière') { ?>
...
<section class="content">
    ...
    <div class="box box-success">
        <div class="box-body">
            ...
            <?php
            $actionUrl = route('storeotherexpense');
            ?>
            ...
            <div class="expensemaincontainer">
                ...
                <div class="col-md-12">
                    ...
                    <?php
                    $cashierId = (checkloggedinuserdata() == 'Cashier') ? auth()->user()->id : $model->cashier_id;
                    ?>
                    <div class="col-md-4">
                        <div class="form-group {{ $errors->has('cashier_id') ? 'has-error' :'' }}">
                            ...
                            <div class="col-md-12">
                                <?php echo Form::select('cashier_id', $cashier, $cashierId, ['class' => 'form-control selectpicker', 'data-live-search' => 'true', 'id' => 'admin_managers']); ?>
                            </div>
                        </div>
                    </div>
                    <?php if (checkloggedinuserdata() == 'Agent' || checkloggedinuserdata() == 'Cashier') { ?>
    ...
    $(document).ready(function() {
        ...
        $('#createExpenseForm').validate({
            submitHandler: function(form) {
                ...
                var urlz = '<?php echo url("otherexpense/store"); ?>';
                $.ajax({
                    url: urlz,
                    async: false,
                    type: 'POST',
                    ...
                    success: function(data) {
                        ...
                        window.location.href = '<?php echo route("otherexpenses") ?>';
