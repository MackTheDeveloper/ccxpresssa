...
<body>
    ...
    ?>
            ...
            <div class="box box-success" style="width: 100%;margin: 0px auto;">
                <div class="box-body cargo-forms" style="color: #000">
                    ...
                    <div style="width: 100%;margin-bottom: 15px;margin-top: 15px;">
                        ...
                        <div style="width: 40%;float: left;border-bottom: 1px solid #ccc">{{!empty($items->aeropost_scan_status) ? Config::get('app.ups_new_scan_status')[$items->aeropost_scan_status] : '-'}}</div>
                    </div>
        ...
        <?php if (count($aeropostFileAssignedToDeliveryBoy) != $i) { ?>
            <pagebreak></pagebreak>
        <?php } ?>
    <?php $i++;
    } ?>
