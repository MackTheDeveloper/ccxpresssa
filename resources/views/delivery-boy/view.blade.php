...
<section class="content-header" style="    display: block;position: relative;top: 0px;">
	<h1 style="font-size: 20px !important;margin-top: 0px;font-weight: 600;">View Details - <?php echo $model->name; ?><a style="line-height:15px;float: right;" class="btn round orange btn-warning" href="{{route('cashcollectiondetailsdeliveryboy',[$model->id])}}">Cash Collection</a><a style="line-height:15px;float: right;margin-right: 10px;" class="btn round orange btn-warning" href="{{route('manifestdetailsdeliveryboy',[$model->id])}}">Manifest Details</a></h1>
</section>
	...
	<div class="box box-success">
		<div class="box-body">
			...
			<div class="db-ups-files">
				<?php echo View::make('delivery-boy.db-ups-files', array('upsFileAssignedToDeliveryBoy' => $upsFileAssignedToDeliveryBoy))->render(); ?>
			</div>
