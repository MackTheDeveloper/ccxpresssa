<div style="margin-bottom: 10px;float:left;width:100%">
    ...
    <button style="float: right;margin-right:10px" id="btnShipmentNotDelivered" class="btn btn-danger btnShipmentNotDelivered" value="{{route('deliveryboyshipmentnotdelivered',['Aeropost',$deliveryBoyId])}}">Not Delivered</button>
</div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).delegate("#selectAll", "click", function(e) {
            $('#example1 .singlecheckbox').prop('checked', this.checked);
            var checked = [];
