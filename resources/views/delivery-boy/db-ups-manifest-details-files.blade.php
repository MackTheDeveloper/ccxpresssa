<div style="margin-bottom: 10px;float:left;width:100%">
    ...
    <button style="float: right;margin-right:10px" id="btnShipmentNotDelivered" class="btn btn-danger btnShipmentNotDelivered" value="{{route('deliveryboyshipmentnotdelivered',['UPS',$deliveryBoyId])}}">Not Delivered</button>
</div>
<table id="example" class="display nowrap" style="width:100%">
    ...
    <tbody>
        ...
        foreach ($upsFileAssignedToDeliveryBoy as $k => $items) {
            ...
            if ($items->ups_scan_status == 7) {
                $getCommentOfDelivery = app('App\Common')->getCommentOfDelivery($items->id, 'ups');
