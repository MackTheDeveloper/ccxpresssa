...
@section('title')
<?php echo 'View House File Invoice'; ?>
@stop
...
<section class="content-header">
    <h1><?php echo 'View House File Invoice'; ?><a style="float: right;padding-right: 10px" title="Click here to print" target="_blank" href="{{ route('printinvoice',[$invoice['id'],'housefile']) }}"><i class="fa fa-print"></i></a></h1>
</section>
                    ...
                    <div class="">
                        <table CELLSPACING="0" CELLPADDING="0" style="border: 1px solid #ccc;width: 100%;font-family: sans-serif;color: #636b6f">
                            <tr style="border-bottom: 1px solid #ccc;height: 39px;text-align: center;font-weight: bold;">
                                <td style="padding:5px;border-right: 1px solid #ccc;border-bottom: 1px solid #ccc;text-align: center;font-weight: bold;font-size: 12px">House File No.</td>
                                <td style="padding:5px;border-right: 1px solid #ccc;border-bottom: 1px solid #ccc;text-align: center;font-weight: bold;font-size: 12px">House AWB/BL No.</td>
