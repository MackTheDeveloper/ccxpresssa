@extends('layouts.custom_s3')
<title>File Manager</title>
@section('filemanager')
<link rel="stylesheet" type="text/css" href="{{ asset('src/css/libs-main.css') }}" />
<link rel="stylesheet" type="text/css" href="{{ asset('src/css/filemanager.css') }}" />
...
<section class="content">
  ...
  <div class="fm-container">
    ...
    <div class="fm-wrapper box box-success">
      <div class="fm-header">
        <div class="buttons-panel" style="width: 100%">
          <div class="col-md-2">
          ...
          <div class="button-group filter-controls" style="display: none">
          ...
          <div class="button-group clipboard-controls" style="display: none">
      ...
      <div class="fm-footer">
        ...
        <div class="right">
          ...
          <a style="display: none" href="" target="_blank" id="link-to-project" data-bind="attr: {href: config().url, title: lg.support_fm + ' [' + lg.version + ' : ' + config().version + ']'}"></a>
        </div>
...
<script type="text/javascript" src="{{ asset('src/js/libs-main.js') }}"></script>
<script type="text/javascript" src="{{ asset('src/js/filemanager.js')}}"></script>
<script type="text/javascript" src="{{ asset('config/filemanager.init.js')}}"></script>
