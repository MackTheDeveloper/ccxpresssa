...
<tr class="edit-row childrw child-<?php echo $rowId; ?>" data-editlink="{{ route('viewdetailsccpack',[$packageData->id]) }}" id="<?php echo $packageData->id; ?>">
    ...
    <td colspan="1"><?php echo isset(Config::get('app.ups_new_scan_status')[!empty($packageData->ccpack_scan_status) ? $packageData->ccpack_scan_status : '1']) ? Config::get('app.ups_new_scan_status')[!empty($packageData->ccpack_scan_status) ? $packageData->ccpack_scan_status : '1'] : '-';  ?></td>
