...
<section class="content">
    <div class="box box-success" style="float: left;">
        <div class="box-body">
            <?php
            if ($model->id)
                $actionUrl = url('aeropostinvoicepayment/update', $model->id);
            else
                $actionUrl = url('aeropostinvoicepayment/store');
            ?>
            ...
            <div class="col-md-12">
                <div class="col-md-3">
                    <div class="form-group {{ $errors->has('client') ? 'has-error' :'' }}">
                        ...
                        <div class="col-md-12" style=<?php echo !empty($aeropostId) ? "opacity:0.5;pointer-events:none;" : ""  ?>>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <?php echo Form::label('tracking_number', 'Tracking Number', ['class' => 'col-md-12 control-label']); ?>
                        <div class="col-md-12">
                            <?php echo Form::select('tracking_number', $dataTrackingNumbers, $model->tracking_number, ['class' => 'form-control selectpicker ftracking_number', 'data-live-search' => 'true', 'placeholder' => 'Select ...']); ?>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
            ...
            <div class="col-md-12">
                ...
                <div class="form-group col-md-12 btm-sub">
                    ...
                    <a class="btn btn-danger" href="{{route('invoicepaymentslisting', ['aeropost'])}}" title="">Cancel</a>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var urlztnn2 = '<?php echo url("aeropostinvoicepayment/getclients"); ?>';
        $.ajax({
            url: urlztnn2,
            type: 'POST',
            data: {},
        ...
        var urlztnn = '<?php echo url("aeropostinvoicepayment/gettrackingnumbers"); ?>';
        $.ajax({
            url: urlztnn,
            type: 'POST',
            data: {},
            success: function(response) {
                ...
                var html = '<option value="">-- Select --</option>';
                $(userList).each(function(k, v) {
                    html += '<option value="' + v.tracking_no + '">' + v.tracking_no + '</option>';
                });
                $('#tracking_number').html(html);
                $('#tracking_number').selectpicker('refresh');
                $('#loading').hide();
            }
        });

        var urlztnn1 = '<?php echo url("aeropostinvoicepayment/getaeropostinvoices"); ?>';
        $.ajax({
            url: urlztnn1,
            type: 'POST',
            data: {},
            success: function(response) {
                ...
                //$('#invoice_id option[value="<?php //echo $model->invoice_id 
        ...
        <?php if ($invoceId) { ?>
            ...
            var urlztnn = '<?php echo url("aeropostinvoicepayment/getselectedaeropostinvoicedata"); ?>';
            $.ajax({
                url: urlztnn,
                type: 'POST',
                data: {
        ...
        <?php if ($billingParty) { ?>
            ...
            var urlztnn = '<?php echo url("aeropostinvoicepayment/getaeropostinvoicesofclient"); ?>';
            $.ajax({
                url: urlztnn,
                type: 'POST',
                data: {
        ...
        $('#createInvoiceForm').validate({
            submitHandler: function(form) {
                ...
                var urlztnn = '<?php echo url("aeropostinvoicepayment/store"); ?>';
                $.ajax({
                    url: urlztnn,
                    //async:false,
                    type: 'POST',
                    ...
                    success: function(data) {
                        ...
                        window.location.href = "<?php echo route('invoicepaymentslisting', ['aeropost']); ?>";
                    }
                })
        ...
        $('.exchange_currency').change(function() {
            ...
            var urlztnn = '<?php echo url("aeropostinvoicepayment/getcurrencyratesection"); ?>';
            $.ajax({
                url: urlztnn,
                type: 'POST',
                data: {
