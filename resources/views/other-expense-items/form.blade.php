...
@section('title')
<?php echo $model->id ? 'Update Other Expense Item' : 'Add Other Expense Item'; ?>
@stop
@section('sidebar')
...
<section class="content-header">
    <h1><?php echo $model->id ? 'Update Other Expense Item' : 'Add Other Expense Item'; ?></h1>
</section>
...
<section class="content">
    <div class="box box-success">
        <div class="box-body">
                    <?php
                    if($model->id)
                        $actionUrl = url('otherexpenseitem/update',$model->id);
                    else
                        $actionUrl = url('otherexpenseitem/store');    
                    ?>
            ...
            <div class="form-group col-md-12 btm-sub">
                            ...
                            <a class="btn btn-danger" href="{{url('countries')}}" title="">Cancel</a>
            </div>
