...
@section('title')
<?php echo $model->id ? 'Update Country' : 'Add Country'; ?>
@stop
@section('sidebar')
...
<section class="content-header">
    <h1><?php echo $model->id ? 'Update Country' : 'Add Country'; ?></h1>
</section>
...
<section class="content">
    <div class="box box-success">
        <div class="box-body">
                    <?php
                    if($model->id)
                        $actionUrl = url('country/update',$model->id);
                    else
                        $actionUrl = url('country/store');    
                    ?>
