                    ...
                    <div class="col-md-12">
                        <div class="col-md-6">
                                 <div class="form-group {{ $errors->has('cash_credit') ? 'has-error' :'' }}">
                                    <div class="col-md-12">
                                    <?php echo Form::label('cash_credit', 'Payment Mode',['class'=>'control-label']); ?>
                                    </div>
...
<script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#createforms').on('submit', function (event) {
                    ...
                    var urlz = '<?php echo url("warehouse/storecashcreditinfile"); ?>';
                    $.ajax({
                    url:urlz,
                    async:false,
                    type:'POST',
                    ...
                    success:function(data) {
                            ...
                            msg: 'Cash/Credit has been assigned successfully.'
                            });
