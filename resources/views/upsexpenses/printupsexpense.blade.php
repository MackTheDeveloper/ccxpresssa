                                    ...
                                    <div class="mainblk" style="margin-top: 0px; float: none;  width: 100%; padding-bottom: 0px; margin: 0 auto;">
                                        ...
                                        <div class="blockleft" style="margin-bottom: 20px; width: 100%; float: left; padding: 0 10px 0 10px; box-sizing: border-box; border-left: 1px dashed #ccc; border-right: 1px dashed #ccc;font-size:12px">                                            
                                               ...
                                               <div style="float: left;width: 100%; margin: 5px 0 5px 0;">
                                                    ...
                                                    <div style="text-align: right;float: left; width: 49%; font-size: 18px; font-weight: 600;text-transform: uppercase;">UPS Expense</div>
                                                ...
                                                <div style="float: left;width: 30%; margin-bottom: 3px;">
                                                    ...
                                                    <div style="float: left;  width: 30%;"><?php echo $cargoData->file_number; ?></div>
                                                </div>
                                                ...
                                                <div style="float: left;width: 50%; margin-bottom: 3px;">
                                                    <div style="float: left;  width: 12%;color:#000">Type : </div>
                                                    <div style="float: left; width: 88%;">
                                                        <?php echo Config::get('app.cargoOperationType')[$cargoData->courier_operation_type];  ?></div>
                                                </div>
                                                <div style="float: left;width: 50%; margin-bottom: 3px;">
                                                    ...
                                                    {
                                                    $currencyData = App\CashCredit::getCashCreditData($vo->cash_credit_account); echo !empty($currencyData) ? '('.$currencyData->currency_code.')'.' '.$currencyData->name : '-'; 
                                                    }else
                                                    {
                                                        $currencyData = '';
                                                        echo '-';
                                        ...
                                        <thead>
                                            <tr>
                                                <th width="40px" style="border-right:1px solid hsl(0, 0%, 86%);border-bottom:1px solid hsl(0, 0%, 86%); border-top: 1px solid hsl(0, 0%, 86%); border-collapse: collapse;padding:2px;text-align: left;color:#000;font-weight:normal">Sr No.</th>
                                                <th width="360px" style="border-right:1px solid hsl(0, 0%, 86%); border-bottom:1px solid hsl(0, 0%, 86%); border-collapse: collapse;padding: 2px;text-align: left;color:#000;font-weight:normal">Description</th>
                                                <th width="90px" style="border-right:1px solid hsl(0, 0%, 86%); border-bottom:1px solid hsl(0, 0%, 86%); border-collapse: collapse;padding: 2px;text-align: left;color:#000;font-weight:normal">Amount<?php 
                                                $currencyAData = App\Currency::getData($vo->currency);
                                                    if(empty($currencyAData))
                                                        $code = '';
                                                    else
                                                        $code = $currencyAData->code; echo " (".$code.")";?></th>
                                                <th width="165px" style="border-right:1px solid hsl(0, 0%, 86%); border-bottom:1px solid hsl(0, 0%, 86%); border-collapse: collapse;padding: 2px;text-align: left;color:#000;font-weight:normal">Paid to</th>
                                            </tr>
                                        </thead>
                                        ...
                                        <tbody>
                                            ...
                                            { 
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="border-bottom:1px solid hsl(0, 0%, 86%);border-right:1px solid hsl(0, 0%, 86%); padding:5px;font-family: Asap, sans-serif;border-collapse: collapse;text-align: right;"><?php 
                                                        if(empty($currencyData))
                                                            $code = '';
                                                        else
                                                            $code = $currencyData->currency_code;
                                                    echo !empty($v->amount) ? number_format($v->amount,2) : '0.00 '; ?></td>
                                                    <td style="border-bottom:1px solid hsl(0, 0%, 86%);border-right:1px solid hsl(0, 0%, 86%); padding:5px;font-family: Asap, sans-serif;border-collapse: collapse;text-align: left;"><?php $dataUser = app('App\Vendors')->getVendorData($v->paid_to); 
                                                ...
                                                <tr>
                                                        ...
                                                        <td style="padding:5px;font-family: Asap, sans-serif;border-collapse: collapse;text-align: right;"><?php $totalD = App\Expense::getExpenseTotal($vo->expense_id); echo $totalD; ?></td>
                                                        <td style="padding:5px;font-family: Asap, sans-serif;border-collapse: collapse;text-align: left;"></td>
                                                </tr>
                                            <?php } else { ?>
                                        ...
                                        <div style="padding-bottom: 30px">Signature</div>
                                            ...
                                            <div style="float: right; width: 50%; margin-top: 10px; bottom: 0; left: 20px;">
                                                <div style="width: 100%;float: left;margin-bottom: 10px">
                                                    ...
                                                    <div style="width: 70%;float: left;margin-right: 20px"><b><?php $modelUser = new App\User(); 
                                                    $dataUser = $modelUser->getUserName($vo->request_by); echo !empty($dataUser) ? $dataUser->name : '-'; ?>
                                                    </b></div>
                                                </div>
                                                <?php if($cargoExpenseData[0]->expense_request == 'Approved' || $cargoExpenseData[0]->expense_request == 'Disbursement done') { ?>
                                                <div style="width: 100%;float: left;margin-bottom: 10px">
                                                    <div style="width: 30%;float: left;">Approved by</div>
                                                    <div style="width: 70%;float: left;"><b><?php $modelUser = new App\User(); 
