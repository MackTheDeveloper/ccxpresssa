...
@section('title')
<?php echo $model->id ? 'Update UPS File Expense Request' : 'Add UPS File Expense Request'; ?>
@stop
...
<section class="content-header">
    <h1><?php echo $model->id ? 'Update UPS File Expense Request' : 'Add UPS File Expense Request'; ?></h1>
</section>
                ...
                <div class="col-md-12" style="text-align: center;">
                    ...
                    <div class="form-group" style="padding-top: 28px;">
                        ...
                        if ($flagFromWhere == 'flagFromView')
                            $cancleRoute = route('viewdetailsups', [$upsId]);
                        else
    ...
    $(document).ready(function() {
        ...
        $('#createExpenseForm').validate({
            ...
            submitHandler: function(form) {
                ...
                var urlz = '<?php echo url("upsexpense/storeupsexpense"); ?>';
                $.ajax({
                    url: urlz,
                    async: false,
                    type: 'POST',
                    ...
                    success: function(data) {
                        ...
                        <?php if ($flagFromWhere == 'flagFromView') { ?>
                            window.location.href = '<?php echo route('viewdetailsups', [$upsId]) ?>';
                        <?php } else { ?>
                            window.location.href = '<?php echo route("upsexpenses") ?>';
                        <?php } ?>
                ...
                if (submitButtonName == 'CreateExpenseFormButtonSaveNext') {
                    window.location.href = '<?php echo route("createupsexpense") ?>';
