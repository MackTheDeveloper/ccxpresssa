...
<section class="content">
    ...
    <div class="box box-success">
        <div class="box-body">
            ...
            <?php if ($guaranteeData) { ?>
                <input type="hidden" class="identification_flag" name="identification_flag" value="1">
                <input type="hidden" class="decsa_id" name="decsa_id" value="{{ $guaranteeData->id }}">
            <?php } ?>
                            ...
                            <table class="table table-expense" style="">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 10%;">Cost <button id="addNewItems" value="<?php echo url('items/addnewitem', ['cost-items']) ?>" type="button" class="addnewitems" data-module='Cost Item'>Add New</button></th>
    ...
    $(document).ready(function() {
        ...
        $('#createExpenseForm').validate({
            submitHandler: function(form) {
                ...
                var urlz = '<?php echo url("cargo/storeeagentexpenses"); ?>';
                $.ajax({
                    url: urlz,
                    async: false,
                    type: 'POST',
                ...
                if (submitButtonName == 'CreateExpenseFormButtonSaveNext') {
                    window.location.href = '<?php echo route("createagentexpenses", "cargo") ?>';
