...
<section class="content-header">
	<h1 style=""><?php echo 'CCPack - ' . $model->file_number; ?>
		...
		<div class="box-body">
			...
			<div class="" style="float: left;width: 100%;margin-bottom: 10px;">
				<div class="" style="float:left;margin-right: 5px;">
					<a style="" title="Click here to print" class="btn btn-primary" target="_blank" href="{{route('printccpackfile', [$model->id])}}"><i class="fa fa-print"></i></a>
				</div>
			...
			<?php
			$actionUrl = url('ccpack/assignbillingparty');
			?>
			...
			<div class="col-md-12">
				...
				<div class="col-md-3 reason_for_return_div" style="<?php echo $model->ccpack_scan_status == 7 ? 'display:block' : 'display:none' ?>">
					<div class="col-md-12">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#createforms').on('submit', function(event) {
			...
			var urlz = '<?php echo url("ccpack/assignbillingparty"); ?>';
			$.ajax({
				url: urlz,
				async: false,
				type: 'POST',
