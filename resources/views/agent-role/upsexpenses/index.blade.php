        ...
        <tbody>
            ...
            @foreach ($cargoExpenseDataByVoucher as $items)
             <?php $dataExpenses = App\ExpenseDetails::checkExpense($items->expense_id); 
                ...
                ?>
                <tr data-editlink="{{ route('editagentupsexpenses',[$items->expense_id]) }}" id="<?php echo $items->expense_id; ?>" class="edit-row">
                    ...
                    <td>
                        ...
                        <?php if($permissionCourierExpensesEdit && $dataUps->file_close != 1) { ?>
