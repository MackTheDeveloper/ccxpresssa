...
@section('title')
<?php echo $model->id ? 'Update UPS File Expense Request
' : 'Add UPS File Expense Request
'; ?>
@stop
...
<section class="content-header">
    <h1><?php echo $model->id ? 'Update UPS File Expense Request
' : 'Add UPS File Expense Request'; ?></h1>
</section>
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                        <div class="form-group {{ $errors->has('file_number') ? 'has-error' :'' }}">
                            ...
                            <div class="col-md-12">
                                <?php echo Form::select('file_number', $dataFileNumber, $upsId, ['class' => 'form-control selectpicker ffilenumber', 'data-live-search' => 'true', 'placeholder' => 'Select ...']); ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    <div class="col-md-4">
                        <div class="form-group {{ $errors->has('ups_details_id') ? 'has-error' :'' }}">
                            ...
                            <div class="col-md-12" style="pointer-events: none;opacity: 0.5">
                                <?php echo Form::select('ups_details_id', $dataAwbNos, $upsId, ['class' => 'form-control fawb', 'placeholder' => 'Select ...']); ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    <div class="col-md-4">
                        <div class="form-group {{ $errors->has('admin_manager_role') ? 'has-error' :'' }}">
                            ...
                            <div class="col-md-12">
                                <?php echo Form::select('admin_manager_role', $adminManagersRole, '', ['class' => 'form-control selectpicker', 'data-live-search' => 'true']); ?>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4" style="display:none">
                        <div class="form-group {{ $errors->has('admin_managers') ? 'has-error' :'' }}">
                            ...
                            <div class="col-md-12">
                                <?php echo Form::select('admin_managers[]', $adminManagersUsers, '', ['class' => 'form-control selectpicker', 'data-live-search' => 'true', 'multiple' => true, 'id' => 'admin_managers']); ?>
                            </div>
                        </div>
                    </div>
    ...
    $(document).ready(function() {
        ...
        $('#createExpenseForm').validate({
            submitHandler: function(form) {
                ...
                var urlz = '<?php echo url("cargo/storeeagentupsexpenses"); ?>';
                $.ajax({
                    url: urlz,
                    async: false,
                    type: 'POST',
                ...
                if (submitButtonName == 'CreateExpenseFormButtonSaveNext') {
                    window.location.href = '<?php echo route("createagentupsexpenses") ?>';
                    ...
                    $('.count_expense').val('1');
                    var urlznt = '<?php echo url("upsexpense/generateupsvoucheronsavenext"); ?>';
                    $.ajax({
                        url: urlznt,
                        type: 'POST',
                        data: formData,
