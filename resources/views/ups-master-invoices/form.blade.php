        ...
        <div class="box-body">
            ...
            <div class="form-group col-md-12 btm-sub">
                <?php if ($model->id && $permissionCourierInvoicesDelete) { ?>
                    {{-- <a class="btn btn-danger" onclick="return confirm('Are you sure to delete?')" href="{{ route('deleteupsmasterinvoicefromedit',[$model->id]) }}">Delete</a> --}}
                <?php } ?>
                <?php if ($model->id && $permissionUpsInvoicesCopy) { ?>
                    <a class="btn btn-success" href="{{ route('copyupsinvoice',[$model->id]) }}">Copy Invoice</a>
                <?php } ?>
