...
<table id="example" class="display nowrap" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr style="<?php echo $assignedCss.';'.$fcCss; ?>" data-editlink="{{ route('viewdetailsups',$couriers->id) }}" id="<?php echo $couriers->id; ?>" class="edit-row">
                        ...
                        <td><?php echo !empty($couriers->arrival_date) ? date('d-m-Y',strtotime($couriers->arrival_date)) : '-' ?></td>
                            ...
                            <div class='dropdown'>
                                ...
                                <?php if($permissionCourierImportEdit) { ?>
                                    ...
                                    <?php if($permissionCourierImportDelete) { ?>
                                        ...
                                        <?php } ?>
                                        <a class="upload-file" href="javascript:void(0)" id="upload-file-btn" value="{{url('files/upload',['ups',$couriers->id])}}" style="margin-left: 12px">
