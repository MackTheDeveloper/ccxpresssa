...
<head>
    <title>EXPORTATIONS HOUSE</title>
</head>
            ...
            <div class="box-body cargo-forms" style="color: #000">
                ...
                <div style="width: 100%;margin-bottom: 25px;">
                    ...
                    <div style="width:60%;float:left;color:#0000;text-align: center;">
                        <h2 style="margin:0px">EXPORTATIONS HOUSE</h2>
                ...
                <div style="width: 100%;margin-bottom: 15px;font-size: 13px;font-weight: normal;">
                    ...
                    <div style="width: 80%;float: left;border-bottom: 1px dotted #000">
                        <?php echo !empty($model->master_file_number) ? $model->master_file_number : 'Not Assigned';
                        ?></div>
                </div>

                <div style="width: 100%;margin-bottom: 15px;font-size: 13px;font-weight: normal;">
                    <div style="width: 20%;float: left;">House AWB No :</div>
                    <div style="width: 80%;float: left;border-bottom: 1px dotted #000"><?php echo !empty($model->awb_number) ? $model->awb_number : '-'; ?></div>
                </div>

                <div style="width: 100%;margin-bottom: 15px;font-size: 13px;font-weight: normal;">
                    <div style="width: 20%;float: left;">Nom/Expéditeur :</div>
                    <div style="width: 80%;float: left;border-bottom: 1px dotted #000"><b><?php echo !empty($model->shipper_name) ? App\Ups::getConsigneeName($model->shipper_name) : '-'; ?></b></div>
                </div>

                <div style="width: 100%;margin-bottom: 15px;font-size: 13px;font-weight: normal;">
                    <div style="width: 20%;float: left;">Adresse :</div>
                    <div style="width: 80%;float: left;border-bottom: 1px dotted #000"><?php echo !empty($model->shipper_address) ? $model->shipper_address : '-'; ?></div>
                </div>

                <div style="width: 100%;margin-bottom: 15px;font-size: 13px;font-weight: normal;">
                    <div style="width: 20%;float: left;">Destinataire :</div>
                    <div style="width: 80%;float: left;border-bottom: 1px dotted #000"><?php echo !empty($model->consignee_name) ? App\Ups::getConsigneeName($model->consignee_name) : '-'; ?></div>
                </div>

                <div style="width: 100%;margin-bottom: 15px;font-size: 13px;font-weight: normal;">
                    <div style="width: 20%;float: left;">Transport Date :</div>
                    <div style="width: 80%;float: left;border-bottom: 1px dotted #000"><?php echo !empty($model->arrival_date) ? date('d-m-Y', strtotime($model->arrival_date)) : '-'; ?></div>
                </div>
                ...
                <div style="width: 100%;margin-bottom: 15px;font-size: 13px;font-weight: normal;">
                    ...
                    <div style="width: 50%;float: left;">
                        ...
                        <div style="width: 60%;float: left;border-bottom: 1px dotted #000">
                            <?php echo !empty($model->weight) ? $model->weight : '-'; ?>
                        </div>
                    </div>
                </div>
                ...
                <div style="width: 100%;margin-bottom: 15px;font-size: 13px;font-weight: normal;">
                    ...
                    <div style="width: 50%;float: left;">
                        ...
                        <div style="width: 60%;float: left;border-bottom: 1px dotted #000">
                            <?php echo !empty($model->nbr_pcs) ? (int) $model->nbr_pcs : '-'; ?>
                        </div>
                    </div>
