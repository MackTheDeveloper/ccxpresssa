...
<section class="content">
    ...
    <div class="box box-success">
        <div class="box-body">
            ...
            ?>
            {{ Form::open(array('url' => $actionUrl,'class'=>'form-horizontal create-form','enctype'=>"multipart/form-data",'autocomplete'=>'off','id'=>'uploadFileForm')) }}
            {{ csrf_field() }}
            ...
            <div class="col-md-12">
                ...
                <div class="upload_div">
                    ...
                    <div class="form-group {{ $errors->has('import_file') ? 'has-error' :'' }}" id="local_file">
                    ...
                    <div class="form-group {{ $errors->has('agent_id') ? 'has-error' :'' }}" style="display: none">
                    ...
                    <div class="form-group {{ $errors->has('file_name') ? 'has-error' :'' }}" style="display: none">
                ...
                <div class="export_div" style="display:none">
                    ...
                    <div class="form-group {{ $errors->has('export_file') ? 'has-error' :'' }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <span class="help-block">
                                <strong>{{ $errors->first('export_file') }}</strong>
                            </span>
                            @endif
                        </div>
                    </div>
                ...
                <div class="ups_commission_div" style="display:none">
                    ...
                    <div class="form-group {{ $errors->has('ups_commission_file') ? 'has-error' :'' }}">
                        ...
                        <div class="col-md-6">
                            ...
                            @if ($errors->has('ups_commission_file'))
                            <span class="help-block">
                                <strong>{{ $errors->first('ups_commission_file') }}</strong>
                            </span>
                            @endif
                        </div>
                    </div>
                ...
                <div class="import_scan_div" style="display: none">
                    <div class="form-group {{ $errors->has('import_file_import_scan') ? 'has-error' :'' }}">
                ...
                <div class="physical_scan_div" style="display:none">
                    ...
                    <div class="form-group {{ $errors->has('physical_scan_file') ? 'has-error' :'' }}">
                        ...
                        <div class="col-md-6">
                            ...
                            @if ($errors->has('export_file'))
                            <span class="help-block">
                                <strong>{{ $errors->first('physical_scan_file') }}</strong>
                            </span>
                            @endif
                        </div>
                    </div>
