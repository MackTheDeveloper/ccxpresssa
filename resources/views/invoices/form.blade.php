        ...
        <div class="box-body">
            ...
            <div class="form-group col-md-12 btm-sub">
                <?php if ($model->id && $permissionCargoInvoicesDelete) { ?>
                    {{-- <a class="btn btn-danger" onclick="return confirm('Are you sure to delete?')" href="{{ route('deleteinvoicefromedit',[$model->id]) }}">Delete</a> --}}
                <?php } ?>
                <?php if ($model->id && $permissionCargoInvoicesCopy) { ?>
                    <a class="btn btn-success" href="{{ route('copyinvoice',[$model->id]) }}">Copy Invoice</a>
                <?php } ?>
