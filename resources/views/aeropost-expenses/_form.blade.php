...
@section('title')
<?php echo $model->id ? 'Update Aeropost File Expense Request' : 'Add Aeropost File Expense Request'; ?>
@stop
...
<section class="content-header">
    <h1><?php echo $model->id ? 'Update Aeropost File Expense Request' : 'Add Aeropost File Expense Request'; ?></h1>
</section>
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                        <div class="form-group {{ $errors->has('file_number') ? 'has-error' :'' }}">
                            ...
                            <div class="col-md-12">
                                <?php echo Form::select('file_number', $dataFileNumber, $aeropostId, ['class' => 'form-control selectpicker ffilenumber', 'data-live-search' => 'true', 'placeholder' => 'Select ...']); ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    <div class="col-md-4">
                        <div class="form-group {{ $errors->has('aeropost_id') ? 'has-error' :'' }}">
                            ...
                            <div class="col-md-12" style="pointer-events: none;opacity: 0.5">
                                <?php echo Form::select('aeropost_id', $dataAwbNos, $aeropostId, ['class' => 'form-control fawb', 'placeholder' => 'Select ...']); ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12" style="text-align: center;">
                    ...
                    <div class="form-group" style="padding-top: 28px;">
                        ...
                        if ($flagFromWhere == 'flagFromListing')
                            $cancleRoute = route('aeroposts');
                        elseif ($flagFromWhere == 'flagFromView')
                            $cancleRoute = route('viewdetailsaeropost', [$aeropostId]);
                        else
    ...
    $(document).ready(function() {
        ...
        <?php if ($aeropostId) { ?>
            ...
            $.ajax({
                ...
                dataType: "json",
                data: {
                    'aeropostId': '<?php echo $aeropostId; ?>'
                },
                success: function(data) {
        ...
        $('#createExpenseForm').validate({
            ...
            submitHandler: function(form) {
                ...
                var urlz = '<?php echo url("aeropost/expense/store"); ?>';
                $.ajax({
                    url: urlz,
                    async: false,
                    type: 'POST',
                    ...
                    success: function(data) {
                        ...
                        <?php if ($flagFromWhere == 'flagFromView') { ?>
                            window.location.href = '<?php echo route('viewdetailsaeropost', [$aeropostId]) ?>';
                        <?php } else { ?>
                            window.location.href = '<?php echo route("aerpostexpenses") ?>';
                        <?php } ?>
                ...
                if (submitButtonName == 'CreateExpenseFormButtonSaveNext') {
                    window.location.href = '<?php echo route("aeropostexpensecreate") ?>';
                } else {
