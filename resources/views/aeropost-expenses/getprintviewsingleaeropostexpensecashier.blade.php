...
<section class="content-header">
    <h1>File Expense
        ...
        <a style="float: right;padding-right: 20px;margin-top: 5px" title="Click here to print"  target="_blank" href="{{ route('printoneaeropostexpense',[$expenseId,$aeropostId]) }}"><i class="fa fa-print" style="font-size: 25px"></i></a>
        <?php //} ?>
        <a class="btn btn-success" style="float: right;margin-right: 1%;padding: 5px 25px;" title="Go Back" href="{{ route('aerpostexpenses') }}">Back</a>
    </h1>
</section>
...
<section class="content" style="font-family: sans-serif;">
    <div class="box box-success" style="width: 100%;margin: 0px auto;">
        <div class="box-body cargo-forms create-form" style="color: #636b6f">
            ...
            <?php } else { ?>
        <div class="col-md-12" style="float: right;">    
             <?php $actionUrl = route('changeaeropostexpensestatusbycashier'); ?>
                                        ...
                                        <div class="blockleft" style="margin-bottom: 20px; width: 100%; float: left; padding: 0 20px 0 20px; box-sizing: border-box; border-left: 1px dashed #ccc; border-right: 1px dashed #ccc;">                                            
                                               ...
                                               <div style="float: left;width: 100%; margin: 20px 0 30px 0;">
                                                ...
                                                <div style="float: left;width: 100%; margin-bottom: 10px;">
                                                        ...
                                                        <div style="float: left;  width: 80%;  padding-bottom: 4px;"><?php echo !empty($cargoData) ? $cargoData->file_number : '-'; ?></div>
                                                    </div>
                                                <div style="float: left;width: 100%; margin-bottom: 10px;">
                                                ...
                                                <div style="float: left;width: 100%; margin-bottom: 10px;">
                                                    ...
                                                    <div style="float: left; width: 80%;  padding-bottom: 4px;"><?php echo !empty($vo->consignee) ? $vo->consignee : '-'; ?></div>
                                                </div>                       
                                                <div style="float: left;width: 100%; margin-bottom: 10px;">
                                                    <div style="float: left;  width: 20%; font-weight: 600;">Expediteur/Shipper : </div>
                                                    <div style="float: left; width: 80%;  padding-bottom: 4px;"><?php echo !empty($vo->shipper) ? $vo->shipper : '-'; ?></div>
                                                </div>                         
                                                <div style="float: left;width: 50%; margin-bottom: 10px;">
                                                    <div style="float: left;  width: 40%; font-weight: 600;">Type : </div>
                                                    <div style="float: left; width: 60%;  padding-bottom: 4px;">
                                                        <?php echo !empty($cargoData) ? Config::get('app.cargoOperationType')[$cargoData->cargo_operation_type] : '-';  ?></div>
                                                </div>
                                                <div style="float: left;width: 100%; margin-bottom: 10px;">
