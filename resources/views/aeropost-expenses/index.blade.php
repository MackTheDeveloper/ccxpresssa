...
<section class="content-header">
    <h1>Aeropost File Expense Listing</h1>
</section>
        ...
        <div class="box-body">
            <div class="row" style="margin-bottom:20px">
                ...
                <div style="float: right;margin-right: 10px;height: 35px;z-index: 111;top: 18px;">
                    <a style="float:left;margin-right: 10px;" title="Click here to print" target="_blank" href="{{ route('printallaeropostexpense',['all']) }}"><i style="padding:10px" class="fa fa-print btn btn-primary"></i></a>
...
<script type="text/javascript">
    ...
    function DatatableInitiate(status = '', expenseType = '') {
        ...
        $('#example').DataTable({
            ...
            "ajax": {
                url: "{{url('aeropost/expense/listbydatatableserverside')}}", // json datasource
                data: function(d) {
                    d.status = status;
                            ...
                            success: function(data) {
                                if (data.deleted == '0') {
                                    <?php if (checkloggedinuserdata() == 'Cashier') { ?>
                                        var editLink = '<?php echo url("aeropost/getprintviewsingleaeropostexpensecashier"); ?>';
                                        editLink += '/' + expenseId + '/' + data.aeropost_id + '/fromNotification';
                                    <?php } else { ?>
                                        var editLink = '<?php echo url("aeropost/expense/edit"); ?>';
