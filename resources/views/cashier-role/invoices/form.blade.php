...
@section('title')
<?php echo $model->id ? 'Update Invoice' : 'Add Invoice'; ?>
@stop
@section('sidebar')
<?php
if (!empty($model->id)) {
    $countcontainerdetail = App\InvoiceItemDetails::where('invoice_id', $model->id)->count();
} else {
...
<section class="content-header">
    <h1><?php echo $model->id ? 'Update Invoice' : 'Add Invoice'; ?>

        <?php if ($model->id) {
            if ($model->payment_status == 'Pending' || $model->payment_status == 'Partial') { ?>
                <span style="float: right;" class="btn btn-danger"><?php echo $model->payment_status; ?></span>
            <?php } else { ?>
                <span style="float: right;" class="btn btn-success"><?php echo $model->payment_status; ?></span>
        <?php }
        } ?>
    </h1>
</section>
...
<section class="content">
    <div class="box box-success" style="float: left;">
        <div class="box-body">
            <?php
            if ($model->id)
                $actionUrl = url('cashierwarehouseinvoices/update', $model->id);
            else
                $actionUrl = url('cashierwarehouseinvoices/store');
            ?>
            ...
            <div class="invoice_cotainer">
                ...
                <div class="col-md-12" id="container-0">
                    <div class="col-md-5">
                        <div class="form-group {{ $errors->has('file_number') ? 'has-error' :'' }}">
                            ...
                            <div class="col-md-12">
                                <?php //echo Form::select('file_number', $dataFileNumber,$model->cargo_id,['class'=>'form-control ffilenumber selectpicker','data-live-search' => 'true','placeholder' => 'Select ...']); 
                                ?>
                                <input class="form-control ffilenumber" name="file_number" id="file_number" value="<?php echo $model->cargo_id; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div class="form-group {{ $errors->has('hawb_hbl_no') ? 'has-error' :'' }}">
                            <?php echo Form::label('hawb_hbl_no', 'House AWB', ['class' => 'col-md-12  control-label']); ?>
                            <div class="col-md-12">
                                <input class="form-control ffilenumber" name="hawb_hbl_no" id="hawb_hbl_no" value="<?php echo $model->hawb_hbl_no; ?>">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-8 row">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-2" style="text-align: left;">
                                    <button style="float: left;" id="addNewItems" value="<?php echo url('items/addnewitem', ['client']) ?>" type="button" class="addnewitems">Add New</button>
                                </div>
                    ...
                    <div class="sec5" style="float: left;width: 100%;margin-top: 10px">
                        <div class="col-md-12">
                            <table class="invoicemoreexpenses" style="border: 1px solid #ccc;width: 100%">
                                <thead>
                                    <tr style="border-bottom: 1px solid #ccc;height: 39px;text-align: center;font-weight: bold;">
                                        <td style="border-right: 1px solid #ccc;width: 25%;">Items <button id="addNewItems" value="<?php echo url('items/addnewitem', ['billing-items']) ?>" type="button" class="addnewitems">Add New</button></td>
                                ...
                                <tbody>
                                    <?php if (empty($dataInvoiceDetails)) { ?>
                                        <tr id="tbtr-0" style="border-bottom: 1px solid #ccc;height: 39px;">
                                            <td style="border-right: 1px solid #ccc;padding-left: 5px;pointer-events: none;">
                                            ...
                                            <td style="border-right: 1px solid #ccc;padding-left: 5px;">
                                                <?php echo Form::text('quantity[0]', '', ['class' => 'form-control invfield invfieldtbl quantityfld', 'id' => 'quantity-0', 'data-cid' => 0, 'onkeypress' => 'return isNumber(event)', 'readonly' => true]); ?>
                                            </td>
                                            <td style="border-right: 1px solid #ccc;padding-left: 5px;">
                                                <?php echo Form::text('unit_price[0]', '', ['class' => 'form-control invfield invfieldtbl unitpricefld', 'id' => 'unit_price-0', 'data-cid' => 0, 'onkeypress' => 'return isNumber(event)', 'readonly' => true]); ?>
                                            </td>
                                            <td style="padding-left: 5px;border-right: 1px solid #ccc;">
                                                <?php echo Form::text('total_of_items[0]', '', ['class' => 'form-control invfield invfieldtbl totalfld', 'id' => 'total_of_items-0', 'readonly' => true]); ?>
                                            </td>
                                        ...
                                        foreach ($dataInvoiceDetails as $k => $v) {    ?>
                                            <tr id="tbtr-<?php echo $i; ?>" style="border-bottom: 1px solid #ccc;height: 39px;">
                                                ...
                                                if ($v->fees_name == '85') {
                                                    $readonly = 'readonly';
                                                    $cssE = 'pointer-events: none;';
                                                } else {
                                                    $readonly = '';
                                                    $cssE = '';
                                                }
                                                ?>
                                                <td style="border-right: 1px solid #ccc;padding-left: 5px;<?php echo $cssE; ?>">
                                                ...
                                                <td style="border-right: 1px solid #ccc;padding-left: 5px;">
                                                    <?php echo Form::text("quantity[$i]", $v->quantity, ['class' => 'form-control invfield invfieldtbl quantityfld', 'id' => "quantity-$i", 'data-cid' => "$i", $readonly]); ?>
                                                </td>
                                                <td style="border-right: 1px solid #ccc;padding-left: 5px;">
                                                    <?php echo Form::text("unit_price[$i]", $v->unit_price, ['class' => 'form-control invfield invfieldtbl unitpricefld', 'id' => "unit_price-$i", 'data-cid' => $i, $readonly]); ?>
                                                </td>
                                                <td style="padding-left: 5px;border-right: 1px solid #ccc;">
                                                    <?php echo Form::text("total_of_items[$i]", $v->total_of_items, ['class' => 'form-control invfield invfieldtbl totalfld', 'id' => "total_of_items-$i", $readonly]); ?>
                                                </td>
                    ...
                    <div class="sec6" style="float: left;width: 100%;margin-top: 10px">
                        ...
                        <div class="col-md-8" style="padding-right: 62px;">
                            ...
                            <div style="float: left;width: 100%">
                                ...
                                <span style="float:left;width: 50%"><?php echo Form::text('credits', $model->credits, ['class' => 'form-control invfield hcredits', 'style' => 'text-align:right;background: #ececec;', 'id' => 'credit', 'onkeypress' => 'return isNumber(event)']); ?></span>
                                <span class="invfield currency_code" style="float: left;width: 10%;margin-top: 0px;height: 34px;padding-top: 7px;background: #ececec;"></span>
                            </div>
                            <div style="float: left;width: 100%">
            ...
            <div class="form-group col-md-12 btm-sub">
                ...
                <a class="btn btn-danger" href="{{route('cashierwarehouseinvoicesoffile')}}" title="">Cancel</a>
            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#file_number').change(function() {
            ...
            var id = $(this).val();
            var urlzt = '<?php echo url("cashierwarehouseinvoices/gethawboffiles"); ?>';
            $.ajax({
                url: urlzt,
                async: false,
                dataType: "json",
        ...
        <?php if (isset($model->cargo_id) && !isset($id)) { ?>
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                }
            });
            var urlzt = '<?php echo url("invoices/getcargodetailforinvoice"); ?>';
            $.ajax({
                url: urlzt,
                dataType: "json",
                type: 'POST',
                data: {
                    'cargoId': '<?php echo $model->cargo_id; ?>'
                },
                success: function(data) {
                    console.log(data);
                    $('.hshipper').val(data.shipper_name);
                    $('.hconsignee_address').val(data.consignee_name + ', ' + data.consignee_address);
                    $('.hfile_no').val(data.file_number);
                    $('.hawb_no').val(data.awb_bl_no);
        ...
        $('#hawb_hbl_no').change(function() {
            ...
            var urlzt = '<?php echo url("invoices/getcargohouseawbdetailforinvoice"); ?>';
            $.ajax({
                url: urlzt,
                dataType: "json",
                type: 'POST',
                ...
                success: function(data) {
                    $('.hweight').val(data.pvolume);
                    $('select#feesname-0').val('85');
                    $('select.feesnamefld').trigger('change');
                        ...
                        success: function(data) {
                            ...
                            if (data.cash_credit == 'Credit' && parseFloat(finalTotal) > parseFloat(clientLimit)) {
                                ...
                                if (confirm("Total amount is exceeding client limit, Do you want to proceed?")) {
                                    //form.submit();
                                    var urlznt = '<?php echo url("cashierwarehouseinvoices/storecargoinvoiceandprint"); ?>';
                                    $.ajax({
                                        url: urlznt,
                                        type: 'POST',
                                        data: formData,
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.billingCode == 'SCC') {
                            if (data.billingCustomDays < 0) {
                                $('#quantity-' + id).val('0.00');
                                $('#unit_price-' + id).val('0.00');
