...
<section class="content-header">
    <h1>File Expenses
        ...
        ?>
        <a style="float: right;padding-right: 20px;margin-top: 5px" title="Click here to print" target="_blank" href="{{ route('printsingleupsmasterexpense',[$expenseId,$upsMasterId]) }}"><i class="fa fa-print" style="font-size: 25px"></i></a>
        <?php //} 
        ?>
        <a class="btn btn-success" style="float: right;margin-right: 1%;padding: 5px 25px;" title="Go Back" href="{{ route('upsmasterexpenses') }}">Back</a>
    </h1>
</section>
...
<section class="content" style="font-family: sans-serif;">
    <div class="box box-success" style="width: 100%;margin: 0px auto;">
        <div class="box-body cargo-forms create-form" style="color: #636b6f">
            ...
            <?php } else { ?>
                <div class="col-md-12" style="float: right;">
                    <?php $actionUrl = route('changeupsmasterexpensestatusbycashier'); ?>
            ...
            <?php if (!empty($cargoExpenseData)) {
                ...
                foreach ($cargoExpenseData as $ko => $vo) {
                    $vo = (object) $vo;
                    $cargoData = App\UpsMaster::where('id', $vo->ups_master_id)->first();
                            ...
                            <div class="blockleft" style="margin-bottom: 20px; width: 100%; float: left; padding: 0 20px 0 20px; box-sizing: border-box; border-left: 1px dashed #ccc; border-right: 1px dashed #ccc;">
                                ...
                                <div style="float: left;width: 50%; margin-bottom: 10px;">
                                    ...
                                    <div style="float: left; width: 60%;  padding-bottom: 4px;">
                                        <?php echo Config::get('app.cargoOperationType')[$cargoData->ups_operation_type];  ?></div>
                                </div>
                                <div style="float: left;width: 100%; margin-bottom: 10px;">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding:5px;font-family: Asap, sans-serif;border-collapse: collapse;text-align: right;"><?php $totalD = App\Expense::getExpenseTotal($vo->expense_id);
                                                                                                                                                    echo $totalD; ?></td>
                                                <td style="padding:5px;font-family: Asap, sans-serif;border-collapse: collapse;text-align: left;"></td>
                                            </tr>
                                        <?php } else { ?>
