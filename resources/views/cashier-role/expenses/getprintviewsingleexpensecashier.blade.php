...
<section class="content-header">
    <h1>File Expense
        ...
        <a style="float: right;padding-right: 20px;margin-top: 5px" title="Click here to print"  target="_blank" href="{{ route('getprintsingleexpense',[$expenseId,$cargoId]) }}"><i class="fa fa-print" style="font-size: 25px"></i></a>
        <?php //} ?>
        <a class="btn btn-success" style="float: right;margin-right: 1%;padding: 5px 25px;" title="Go Back" href="{{ route('cashierexpenses') }}">Back</a>
    </h1>
</section>
...
<section class="content" style="font-family: sans-serif;">
    <div class="box box-success" style="width: 100%;margin: 0px auto;">
        ...
        <?php } else { ?>
        <div class="col-md-12" style="float: right;">    
             <?php $actionUrl = route('changestatusbycashier'); ?>
