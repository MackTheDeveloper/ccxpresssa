...
<section class="content-header">
    <h1>File Expense
        ...
        <a style="float: right;padding-right: 20px;margin-top: 5px" title="Click here to print"  target="_blank" href="{{ route('getprintsinglehousefileexpense',[$expenseId,$houseId]) }}"><i class="fa fa-print" style="font-size: 25px"></i></a>
        <?php //} ?>
        <a class="btn btn-success" style="float: right;margin-right: 1%;padding: 5px 25px;" title="Go Back" href="{{ route('cashierhousefileexpenses') }}">Back</a>
    </h1>
</section>
...
<section class="content" style="font-family: sans-serif;">
    <div class="box box-success" style="width: 100%;margin: 0px auto;">
        ...
        <?php } else { ?>
        <div class="col-md-12" style="float: right;">    
             <?php $actionUrl = route('changehousefilestatusbycashier'); ?>
        ...
        <input type="hidden" name="id" value="<?php echo $cargoExpenseData[0]->expense_id; ?>">
        ...
        <div class="col-md-3">
            <div class="form-group {{ $errors->has('expense_request') ? 'has-error' :'' }}">
                <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <?php echo Form::select('expense_request', $expenseStatus,$cargoExpenseData[0]->expense_request,['class'=>'form-control selectpicker','data-live-search' => 'true']); ?>
                    </div>
            </div>
        </div>
        <div class="col-md-4">
                    ...
                    <?php echo Form::label('expense_request_status_note', 'Notes',['class'=>'control-label']); ?>
                                    ...
                                    <div class="col-md-12">
                                        <?php echo Form::textarea('expense_request_status_note',$cargoExpenseData[0]->expense_request_status_note,['class'=>'form-control','rows'=>1]); ?>
                                    </div>
                            </div>
        </div>
         <div class="col-md-3">
    ...
    <?php } ?>
            <?php if(!empty($cargoExpenseData)) { 
                    ...
                    foreach($cargoExpenseData as $ko => $vo)
                        {  $vo = (object) $vo; 
                           $cargoData = App\HawbFiles::where('id',$vo->house_file_id)->first();
                                        ...
                                        <div class="blockleft" style="margin-bottom: 20px; width: 100%; float: left; padding: 0 20px 0 20px; box-sizing: border-box; border-left: 1px dashed #ccc; border-right: 1px dashed #ccc;">                                            
                                               ...
                                               <div style="float: left;width: 100%; margin: 20px 0 30px 0;">
                                                ...
                                                <div style="float: left;width: 100%; margin-bottom: 10px;">
                                                        <div style="float: left; width: 20%; font-weight: 600">File number/DOSSIER : </div>
                                                        <div style="float: left;  width: 80%;  padding-bottom: 4px;"><?php echo $cargoData->file_number; ?></div>
                                                    </div>
                                                <div style="float: left;width: 100%; margin-bottom: 10px;">
                                                    ...
                                                    <div style="float: left;width: 50%; margin-bottom: 10px;">
                                                        <div style="float: left;  width: 40%; font-weight: 600;">BL or AWB No. : </div>
                                                        <div style="float: left;  width: 60%;  padding-bottom: 4px;"><?php echo $vo->bl_awb; ?></div>
                                                    </div>                    
                                                    <div style="float: left;width: 100%; margin-bottom: 10px;">
                                                        <div style="float: left;  width: 20%; font-weight: 600;">Consignee : </div>
                                                        <div style="float: left; width: 80%;  padding-bottom: 4px;"><?php echo $vo->consignee; ?></div>
                                                    </div>                       
                                                    <div style="float: left;width: 100%; margin-bottom: 10px;">
                                                        <div style="float: left;  width: 20%; font-weight: 600;">Expediteur/Shipper : </div>
                                                        <div style="float: left; width: 80%;  padding-bottom: 4px;"><?php echo $vo->shipper; ?></div>
                                                    </div>                         
                                                    <div style="float: left;width: 50%; margin-bottom: 10px;">
                                                        <div style="float: left;  width: 40%; font-weight: 600;">Type : </div>
                                                        <div style="float: left; width: 60%;  padding-bottom: 4px;">
                                                    ...
                                                    <div style="float: left;width: 100%; margin-bottom: 10px;">
                                                        ...
                                                        <div style="float: left; width: 80%;"><?php $currencyData = App\CashCredit::getCashCreditData($vo->cash_credit_account); echo !empty($currencyData) ? '('.$currencyData->currency_code.')'.' '.$currencyData->name : '-'; ?></div>
                                                    </div>
                                                    <div style="float: left;width: 100%; margin-bottom: 10px;">
