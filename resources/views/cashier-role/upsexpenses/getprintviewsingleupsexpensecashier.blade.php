...
@section('breadcrumbs')
    @include('menus.cashier-ups-expense')
@stop
...
<section class="content-header">
    <h1>File Expenses 
        ...
        <a style="float: right;padding-right: 20px;margin-top: 5px" title="Click here to print"  target="_blank" href="{{ route('getprintsingleupsexpense',[$expenseId,$upsId]) }}"><i class="fa fa-print" style="font-size: 25px"></i></a>
        <?php //} ?>
        <a class="btn btn-success" style="float: right;margin-right: 1%;padding: 5px 25px;" title="Go Back" href="{{ route('cashierupsexpenses') }}">Back</a>
    </h1>
</section>
...
<section class="content" style="font-family: sans-serif;">
    <div class="box box-success" style="width: 100%;margin: 0px auto;">
        <div class="box-body cargo-forms create-form" style="color: #636b6f">
            ...
            <?php } else { ?>
             <div class="col-md-12" style="float: right;">    
             <?php $actionUrl = route('changeupsstatusbycashier'); ?>
                        ...
                        {  $vo = (object) $vo; 
                           $cargoData = App\Ups::where('id',$vo->ups_details_id)->first();
                            ...
                            <?php if(!empty($cargoExpenseDetailsData)) {  ?>
                                    ...
                                    <div class="mainblk" style="margin-top: 20px; margin: 0 auto;">
