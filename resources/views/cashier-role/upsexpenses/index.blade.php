        ...
        <tbody>
            ...
            @foreach ($cargoExpenseDataByVoucher as $items)
             <?php $dataExpenses = App\ExpenseDetails::checkExpense($items->expense_id); 
                ...
                ?>
                <tr data-editlink="{{ route('getprintviewsingleupsexpensecashier',[$items->expense_id,$items->ups_details_id,'fromNotification']) }}" id="<?php echo $items->expense_id; ?>" class="edit-row">
