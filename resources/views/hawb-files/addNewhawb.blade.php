                  ...
                  <div class="col-md-12 hawbbimport">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-6">
                            <div class="form-group {{ $errors->has('consignee_name') ? 'has-error' :'' }}">
                                ...
                                <div class="col-md-8">
                                <?php echo Form::text('consignee_name',$model->consignee_name,['class'=>'form-control consignee_name','placeholder' => 'Enter Consignee Name']); ?>
                                <span class="text-danger">
                                    <strong id="consignee_name-error1"></strong>
                                </span>
                    ...
                    <div class="col-md-12 col-sm-12 packagediv">
                        <div class="col-md-6 col-sm-6 form-group {{ $errors->has('pweight') ? 'has-error' :'' }}">
                    ...
                    <div class="col-md-12 col-sm-12 packagediv">
                            <div class="col-md-6 col-sm-6 form-group {{ $errors->has('pvolume') ? 'has-error' :'' }}">
                         ...
                         <div class="col-md-12 col-sm-12 packagediv">
                            <div class="col-md-6 col-sm-6 form-group {{ $errors->has('ppieces') ? 'has-error' :'' }}">
                ...
                success:function(data) {
                    ...
                    if(data.errors) {
                        if(data.errors.consignee_name){
                            $( '#consignee_name-error1' ).html( data.errors.consignee_name[0] );
                            }
