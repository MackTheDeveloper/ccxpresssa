    ...
    <div class="box box-success" style="width: 100%;margin: 0px auto;">
        <div class="box-body cargo-forms" style="color: #000">
            ...
            <div style="width: 100%;margin-bottom: 15px;font-size: 13px;font-weight: normal;">
                ...
                <div style="width: 80%;float: left;border-bottom: 1px dotted #000"><?php echo !empty($model->export_hawb_hbl_no) ? $model->export_hawb_hbl_no : '-'; ?></div>
            </div>
            ...
            <div style="width: 100%;margin-bottom: 15px;font-size: 13px;font-weight: normal;">
                    ...
                    <div style="width: 80%;float: left;border-bottom: 1px dotted #000"><?php echo !empty($model->opening_date) ? date('d-m-Y',strtotime($model->opening_date)) : '-'; ?></div>
            </div>
