...
<section class="content">
    <div class="box box-success" style="float: left;">
        <div class="box-body">
            <?php
            if ($model->id)
                $actionUrl = url('ccpackinvoicepayment/update', $model->id);
            else
                $actionUrl = url('ccpackinvoicepayment/store');
            ?>
            ...
            <div class="col-md-12">
                <div class="col-md-4">
                    <div class="form-group {{ $errors->has('client') ? 'has-error' :'' }}">
                        ...
                        <div class="col-md-6" style=<?php echo !empty($ccpackId) ? "opacity:0.5;pointer-events:none;" : ""  ?>>
            ...
            <div class="col-md-12">
                ...
                <div class="form-group col-md-12 btm-sub">
                    ...
                    <a class="btn btn-danger" href="{{route('invoicepaymentslisting', ['ccpack'])}}" title="">Cancel</a>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var urlztnn2 = '<?php echo url("ccpackinvoicepayment/getclients"); ?>';
        $.ajax({
            url: urlztnn2,
            type: 'POST',
            data: {},
        ...
        var urlztnn1 = '<?php echo url("ccpackinvoicepayment/getccpackinvoices"); ?>';
        $.ajax({
            url: urlztnn1,
            type: 'POST',
            data: {},
        ...
        <?php if ($invoceId) { ?>
            ...
            var urlztnn = '<?php echo url("ccpackinvoicepayment/getselectedccpackinvoicedata"); ?>';
            $.ajax({
                url: urlztnn,
                type: 'POST',
                data: {
        ...
        <?php if ($billingParty) { ?>
            ...
            var urlztnn = '<?php echo url("ccpackinvoicepayment/getccpackinvoicesofclient"); ?>';
            $.ajax({
                url: urlztnn,
                type: 'POST',
                data: {
        ...
        $('#createInvoiceForm').validate({
            submitHandler: function(form) {
                ...
                var urlztnn = '<?php echo url("ccpackinvoicepayment/store"); ?>';
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        window.location.href = "<?php echo route('invoicepaymentslisting', ['ccpack']); ?>";
                    }
                })
        ...
        $('.exchange_currency').change(function() {
            ...
            var urlztnn = '<?php echo url("ccpackinvoicepayment/getcurrencyratesection"); ?>';
            $.ajax({
                url: urlztnn,
                type: 'POST',
                data: {
