        ...
        <div class="box box-success" style="width: 100%;margin: 0px auto;">
            <div class="box-body cargo-forms" style="color: #000">
                ...
                <div style="width: 100%;margin-bottom: 10px;font-size: 13px;font-weight: normal;">
                    ...
                    <div style="width: 47%;float: left;">
                        <div style="width: 36%;float: left;">DATE D'ARRIVEE :</div>
                        <div style="width: 64%;float: left;border-bottom: 1px dotted #000"><?php echo !empty($model->arrival_date) ? date('d-m-Y', strtotime($model->arrival_date)) : '-'; ?></div>
                    </div>
                </div>
