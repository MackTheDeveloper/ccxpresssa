...
<section class="content-header">
    <h1>UPS Master Files Listing</h1>
</section>
    ...
    <div class="box box-success">
        <div class="box-body">
            ...
            <div class="row" style="margin-bottom:20px">
                ...
                <div class="col-md-2">
                    <?php echo Form::select('file_name', [0 => 'All Files (I, E)', 1 => 'Import', 2 => 'Export'], 0, ['class' => 'form-control selectpicker saveStateThis', 'data-live-search' => 'true', 'id' => 'file_type']); ?>
                </div>
                <div class="from-date-filter-div filterout col-md-2" style="display: block">
                    <input type="text" name="from_date_filter" placeholder=" -- From Date" id="fromDate" class="saveStateThis form-control datepicker from-date-filter">
                </div>
                <div class=" to-date-filter-div filterout col-md-2" style="display: block">
                    <input type="text" name="to_date_filter" placeholder=" -- To Date" id="toDate" class="saveStateThis form-control datepicker to-date-filter">
                </div>
    ...
    $(document).ready(function() {
        ...
        $(document).delegate('.expandpackage', 'click', function() {
            ...
            if (thiz.hasClass('fa-plus')) {
                ...
                var rowId = $(this).data('rowid');
                $.ajax({
                    url: 'ups-master/expandhousefiles',
                    type: 'POST',
                    data: {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                <?php if (checkloggedinuserdata() == 'Agent') { ?>
                                    var editLink = '<?php echo url("agent/ups-master/view"); ?>';
