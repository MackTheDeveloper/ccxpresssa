...
<section class="content-header">
	<h1>
		<div style="float: left"><?php echo 'Aeropost - ' . $model->file_number; ?></div>
	...
	<div class="box box-success">
		<div class="box-body">
						...
						<div class="row-<?php echo $i; ?>">
							<div class="col-md-12" style="padding:0px">
								...
								<div class="col-md-12" style="padding: 0px;margin-bottom: 4px;background: #f3f3f3;">
									<?php
									$actionUrl = url('warehouseaeropost/assignstatusbywarehousecourieraeropost');
									?>
									...
									<div class="col-md-8">
										<div class="col-md-3 row">
											<div class="form-group {{ $errors->has('aeropost_scan_status') ? 'has-error' :'' }}">
												<div class="col-md-12">
													<?php echo Form::label('aeropost_scan_status', 'File Status', ['class' => 'control-label']); ?>
												</div>
												<div class="col-md-12">
													<?php echo Form::select('aeropost_scan_status', Config::get('app.ups_new_scan_status'), $items->aeropost_scan_status, ['class' => 'form-control selectpicker aeropost_scan_status-main-' . $items->id, 'data-live-search' => 'true', 'data-container' => 'body']); ?>
												</div>
											</div>
										</div>
									...
									<div class="col-md-4" style="display:none;text-align:right;margin-top: 10px;color: green;"> File Status : <?php echo isset(Config::get('app.ups_new_scan_status')[!empty($items->aeropost_scan_status) ? $items->aeropost_scan_status : '1']) ? Config::get('app.ups_new_scan_status')[!empty($items->aeropost_scan_status) ? $items->aeropost_scan_status : '1'] : '-'; ?>
									</div>
								...
								<div class="col-md-12" style="padding: 0px 0px;margin-bottom: 15px;">
									...
									if (!empty($checkInvoiceIsGeneratedOrNot) && $checkInvoiceIsGeneratedOrNot->payment_status == 'Paid') {
										...
										$ajaxData['changedBy'] = '-';
											...
											<!-- <div class="aeropoststep4invoiceandpayment-ajax-container aeropoststep4invoiceandpayment-ajax-container-<?php //echo $items->id; 
			...
			<?php /* if (checkNonBoundedWH() == 'Yes' && $items->display_notification_nonbounded_wh == 1) { ?>
				<a style="margin-top: 10px" class="btn btn-success" href="{{route('acceptfilessubmit',[$items->id,'aeropost','aeropost_details'])}}">Receive Shipment</a>
			<?php } else { }*/
			?>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('.btn-assignstatusbywarehousecouriermaster').click(function(e) {
			...
			$('#loading').show();
			var id = tId;
			var aeropost_scan_status = $('.aeropost_scan_status-main-' + tId + " option:selected").val();
			var urlz = '<?php echo url("warehouseaeropost/assignstatusbywarehousecourieraeropostmaster"); ?>';
			$.ajax({
				url: urlz,
				type: 'POST',
				data: {
