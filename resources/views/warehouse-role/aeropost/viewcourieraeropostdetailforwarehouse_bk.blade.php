...
<section class="content-header">
	<h1>
		...
		<?php } else { ?>
			<div style="float: right;margin-right: 15px;color: green;"> File Status : <?php echo isset(Config::get('app.ups_new_scan_status')[!empty($items->aeropost_scan_status) ? $items->aeropost_scan_status : '1']) ? Config::get('app.ups_new_scan_status')[!empty($items->aeropost_scan_status) ? $items->aeropost_scan_status : '1'] : '-'; ?>
			</div>
		<?php } ?>
	</h1>
</section>
				...
				<div class="col-md-12 row">
					<div class="col-md-3 row">
						<div class="form-group {{ $errors->has('aeropost_scan_status') ? 'has-error' :'' }}">
							...
							<div class="col-md-12">
								<?php echo Form::select('aeropost_scan_status', Config::get('app.ups_new_scan_status'), $items->aeropost_scan_status, ['class' => 'form-control selectpicker fagent_id', 'data-live-search' => 'true', 'id' => 'aeropost_scan_status', 'data-container' => 'body']); ?>
							</div>
						</div>
					</div>
