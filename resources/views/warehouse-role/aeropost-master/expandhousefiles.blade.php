...
<tr class="edit-row childrw child-<?php echo $rowId; ?>" data-editlink="{{ route('viewdetailsaeropost',[$packageData->id]) }}" id="<?php echo $packageData->id; ?>" data-masterid="{{$packageData->master_aeropost_id}}">
    <td colspan="1"><input type="checkbox" name="singlecheckbox" class="singlecheckbox singlecheckbox-{{$packageData->master_aeropost_id}}" id="{{$packageData->id}}" value="{{$packageData->id}}" /></td>
