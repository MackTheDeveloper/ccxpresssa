...
<section class="content-header">
    <h1>Aeropost Master Files Listing<button style="float: right;width: 13%;" id="btnAssignDeliveryBoy" class="btn btn-success btnAssignDeliveryBoy" value="{{route('assign-delivery-boy',['aeropost'])}}">Assign Delivery Boy</button></h1>
</section>
    ...
    $(document).ready(function() {
        ...
        $(document).delegate('.expandpackage', 'click', function() {
            ...
            if (thiz.hasClass('fa-plus')) {
                ...
                var rowId = $(this).data('rowid');
                $.ajax({
                    url: 'warehouse/aeropost-master/expandhousefiles',
                    type: 'POST',
                    data: {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                if (data.deleted == '0') {
                                    ...
                                    var editLink = '<?php echo url("warehouseaeropost/viewcourieraeropostdetailforwarehousemaster"); ?>';
