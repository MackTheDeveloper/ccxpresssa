...
<section class="content-header">
	<h1>
		<div style="float: left"><?php echo 'UPS - ' . $items->file_number; ?></div>
		<?php if ($items->file_close == 1) { ?>
			<div style="color:red;float:right">CLOSED</div>
		<?php } else { ?>
			<div style="float: right;margin-right: 15px;color: green;"> File Status : <?php echo isset(Config::get('app.ups_new_scan_status')[!empty($items->ups_scan_status) ? $items->ups_scan_status : '1']) ? Config::get('app.ups_new_scan_status')[!empty($items->ups_scan_status) ? $items->ups_scan_status : '1'] : '-'; ?>
			</div>
		<?php } ?>
	</h1>
</section>
				...
				<div class="col-md-12 row">
					<div class="col-md-3 row">
						<div class="form-group {{ $errors->has('ups_scan_status') ? 'has-error' :'' }}">
							...
							<div class="col-md-12">
								<?php echo Form::select('ups_scan_status', Config::get('app.ups_new_scan_status'), $items->ups_scan_status, ['class' => 'form-control selectpicker fagent_id ups_scan_status_outside', 'data-live-search' => 'true', 'id' => 'ups_scan_status', 'data-container' => 'body']); ?>
							</div>
						</div>
					</div>
					<div class="col-md-3 reason_for_return_div" style="<?php echo $items->ups_scan_status == 7 ? 'display:block' : 'display:none' ?>">
						<div class="col-md-12">
							<?php echo Form::label('reason_for_return', 'Reason', ['class' => 'control-label']); ?>
						</div>
						<div class="col-md-12">
							<?php echo Form::select('reason_for_return', Config::get('app.reasonOfReturn'), $items->reason_for_return, ['class' => 'form-control selectpicker reason_for_return', 'data-live-search' => 'true', 'data-container' => 'body', 'placeholder' => 'Select Reason']); ?>
						</div>
					</div>
					<div class="col-md-3">
						<div class="col-md-12">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('.ups_scan_status_outside').change(function() {
			var tVal = $(this).val();
			if (tVal == 7) {
