	...
	<div class="box box-success">
		<div class="box-body">
							...
							<div class="col-md-12" style="padding:0px">
								...
								<div class="col-md-12 basicDetaiCls" style="padding: 0px;margin-bottom: 15px;">
									...
									<div class="newline" style="float: left;width: 50%; margin-bottom: 10px;">
										<span class="viewblk1">Consignataire / Consignee : </span>
										<span class="viewblk2">
											<?php $data = app('App\Clients')->getClientData($items->consignee_name);
									...
									<div class="newline" style="float: left;width: 50%; margin-bottom: 10px;">
										...
										<span class="viewblk2"><?php echo !empty($items->consignee_telephone) ? $items->consignee_telephone : '-'; ?></span>
									</div>
									<div style="float: left;width: 50%; margin-bottom: 10px;">
										<span class="viewblk1">Shipper Phone Number: </span>
										<span class="viewblk2"><?php echo !empty($items->shipper_telephone) ? $items->shipper_telephone : '-'; ?></span>
									</div>
									<div class="newline" style="float: left;width: 50%; margin-bottom: 10px;">
										<span class="viewblk1">Billing Term : </span>
										<span class="viewblk2"><?php echo App\Ups::getBillingTerm($items->id); ?></span>
									</div>
									<div style="float: left;width: 50%; margin-bottom: 10px;">
										<span class="viewblk1">Custom File Number : </span>
										<span class="viewblk2"><?php $dataCustom = App\Customs::getData($items->id);
									...
									<div style="float: left;width: 50%; margin-bottom: 10px;">
										<span class="viewblk1">Number of Pieces : </span>
										<span class="viewblk2"><?php echo !empty($items->nbr_pcs) ? (int) $items->nbr_pcs : '-' ?></span>
									</div>
									<div class="newline" style="float: left;width: 50%; margin-bottom: 10px;">
										<span class="viewblk1">Arrival Date : </span>
										<span class="viewblk2"><?php echo date('d-m-Y', strtotime($items->arrival_date)); ?></span>
									</div>
									<div style="float: left;width: 50%; margin-bottom: 10px;">
								...
								<div class="col-md-12" style="padding: 0px;margin-bottom: 4px;background: #f3f3f3;">
									<?php
									$actionUrl = url('warehouseups/assignstatusbywarehousecourier');
									?>
									...
									<div class="col-md-8">
										<div class="col-md-3 row">
											<div class="form-group {{ $errors->has('ups_scan_status') ? 'has-error' :'' }}">
												<div class="col-md-12">
													<?php echo Form::label('ups_scan_status', 'File Status', ['class' => 'control-label']); ?>
												</div>
												<div class="col-md-12">
													<?php echo Form::select('ups_scan_status', Config::get('app.ups_new_scan_status'), $items->ups_scan_status, ['class' => 'form-control selectpicker ups_scan_status-main-' . $items->id, 'data-live-search' => 'true', 'data-container' => 'body']); ?>
												</div>
											</div>
										</div>
									...
									<div class="col-md-4" style="display:none;text-align:right;margin-top: 10px;color: green;"> File Status : <?php echo isset(Config::get('app.ups_new_scan_status')[!empty($items->ups_scan_status) ? $items->ups_scan_status : '1']) ? Config::get('app.ups_new_scan_status')[!empty($items->ups_scan_status) ? $items->ups_scan_status : '1'] : '-'; ?>
									</div>
								...
								<div class="col-md-12" style="padding: 0px 0px;margin-bottom: 15px;">
									...
									<div class="detail-container">
										<?php $actionUrl = url('warehouse/ups/upsstep1shipmentstatus'); ?>
										{{ Form::open(array('url' => $actionUrl,'class'=>'form-horizontal create-form client-side','id'=>'upsstep1shipmentstatus','autocomplete'=>'off')) }}
										{{ csrf_field() }}
										<div style="margin-top:0px;float:left;width:100%">
											...
											<div style="width:5%;float:left;">
												<button type="button" class="btn btn-success btn-upsstep1shipmentstatus btn-upsstep1shipmentstatus-<?php echo $items->id; ?>" data-id="<?php echo $items->id; ?>" style="border-radius: 0px;height: 34px;">Save</button>
											</div>
											...
											$dataComments = DB::table('verification_inspection_notes')->where('flag_note', 'V')->where('ups_id', $items->id)->orderBy('id', 'desc')->get();
											...
											<div class="upsstep1shipmentstatus-ajax-container upsstep1shipmentstatus-ajax-container-<?php echo $items->id; ?>" style="float:left;width:100%;margin-top:15px">
									...
									<div class="detail-container">
										<?php $actionUrl = url('warehouse/ups/upsstep2custominspection'); ?>
										{{ Form::open(array('url' => $actionUrl,'class'=>'form-horizontal create-form client-side','id'=>'upsstep2custominspection','autocomplete'=>'off')) }}
										{{ csrf_field() }}
										<div style="margin-top:0px;float:left;width:100%">
											...
											<div style="width:5%;float:left;">
												<button type="button" class="btn btn-success btn-upsstep2custominspection btn-upsstep2custominspection-<?php echo $items->id; ?>" data-id="<?php echo $items->id; ?>" style="border-radius: 0px;height: 34px;">Save</button>
											</div>
											...
											$dataComments = DB::table('verification_inspection_notes')->where('flag_note', 'I')->where('ups_id', $items->id)->orderBy('id', 'desc')->get();
											if (count($dataComments) > 0)
												$ajaxData['comments'] = $dataComments;
											else
												$ajaxData['comments'] = '';
											...
											<div class="upsstep2custominspection-ajax-container upsstep2custominspection-ajax-container-<?php echo $items->id; ?>" style="float:left;width:100%;margin-top:15px">
												<div style="float:left;width:100%;margin-bottom:10px;">
									...
									<div class="detail-container">
										...
										<?php $actionUrl = url('warehouse/ups/upsstep3movetononboundedwh'); ?>
										{{ Form::open(array('url' => $actionUrl,'class'=>'form-horizontal create-form client-side','id'=>'upsstep3movetononboundedwh','autocomplete'=>'off')) }}
										{{ csrf_field() }}
										<div style="margin-top:0px;float:left;width:100%">
											...
											<div style="width:5%;float:left;">
												<button type="button" class="btn btn-success btn-upsstep3movetononboundedwh btn-upsstep3movetononboundedwh-<?php echo $items->id; ?>" data-id="<?php echo $items->id; ?>" style="border-radius: 0px;height: 34px;">Save</button>
											</div>
											...
											<div class="upsstep3movetononboundedwh-ajax-container upsstep3movetononboundedwh-ajax-container-<?php echo $items->id; ?>" style="float:left;width:100%;margin-top:15px">
												<div style="float:left;width:100%;margin-bottom:10px;">
									...
									<?php
									//$checkInvoiceIsGeneratedOrNot = app('App\Invoices')->checkInvoiceIsGeneratedOrNot($items->id, 'ups');
									$checkInvoiceIsGeneratedOrNot = app('App\Invoices')->checkAllInvoiceIsGeneratedOrNot($items->id, 'ups');
									$checkIfAnyInvoicePending = app('App\Invoices')->checkIfAnyInvoicePending($items->id, 'ups');
									?>
									...
									<div class="detail-container">
										...
										<?php } ?>
										<?php $actionUrl = url('warehouse/ups/upsstep4invoiceandpayment'); ?>
										{{ Form::open(array('url' => $actionUrl,'class'=>'form-horizontal create-form client-side','id'=>'upsstep4invoiceandpayment','autocomplete'=>'off')) }}
										{{ csrf_field() }}
										<div style="margin-top:0px;float:left;width:100%">

											<div style="width:50%;margin-bottom:10px;margin-top:10px;float:left">
												<?php
												$getTotalDaysOfCharge = app('App\Invoices')->getTotalDaysOfCharge($items->id, 'ups');
												$getTotalChargableDays = app('App\Invoices')->getTotalChargableDays($items->id, 'ups');
												$getTotalBilledDays = app('App\Invoices')->getTotalBilledDays($items->id, 'ups');
												?>
											...
											<div style="width:5%;float:left;">
												<button type="button" class="btn btn-success btn-upsstep4invoiceandpayment btn-upsstep4invoiceandpayment-<?php echo $items->id; ?>" data-id="<?php echo $items->id; ?>" style="border-radius: 0px;height: 34px;">Save</button>
											</div>
														...
														<tbody>
															<?php foreach ($checkInvoiceIsGeneratedOrNot as $k => $v) { ?>
																<tr>
																	...
																	<td><a style=" margin-left: 10px;" title="Click here to print" target="_blank" href="{{ route('printinvoice',[$v->id,'ups']) }}"><span style="border-radius:0px" class="btn btn-success"><i class="fa fa-print"></i> Print</span></a></td>
																</tr>
															<?php } ?>
														</tbody>
													</table>
									...
									if (!empty($checkInvoiceIsGeneratedOrNot) && $checkInvoiceIsGeneratedOrNot->payment_status == 'Paid') {
										...
										$ajaxData['changedBy'] = '-';
											...
											<!-- <div class="upsstep4invoiceandpayment-ajax-container upsstep4invoiceandpayment-ajax-container-<?php //echo $items->id; 
									...
									<div class="detail-container">
										<?php $actionUrl = url('warehouse/ups/upsstep5assigndeliveryboy'); ?>
										{{ Form::open(array('url' => $actionUrl,'class'=>'form-horizontal create-form client-side','id'=>'upsstep3movetononboundedwh','autocomplete'=>'off')) }}
										{{ csrf_field() }}
										<div style="margin-top:0px;float:left;width:100%">
											<div style="width:15%;float:left;margin-right:10px;">
											...
											<div style="width:5%;float:left;">
												<button type="button" class="btn btn-success btn-upsstep5assigndeliveryboy btn-upsstep5assigndeliveryboy-<?php echo $items->id; ?>" data-id="<?php echo $items->id; ?>" data-reason='0' style="border-radius: 0px;height: 34px;">Save</button>
											</div>
											...
											<div class="upsstep5assigndeliveryboy-ajax-container upsstep5assigndeliveryboy-ajax-container-<?php echo $items->id; ?>" style="float:left;width:100%;margin-top:15px">
												<div style="float:left;width:100%;margin-bottom:10px;">
											...
											<div style="width:15%;float:left;margin-right:10px;">
												<?php echo Form::select('ups_scan_status', Config::get('app.ups_new_scan_status'), $items->ups_scan_status, ['class' => 'form-control selectpicker ups_scan_status ups_scan_status-' . $items->id, 'data-id' => $items->id, 'data-live-search' => 'true', 'data-container' => 'body', 'placeholder' => 'Select File Status']); ?>
											</div>
											<div style="width:30%;float:left;margin-right:10px;<?php echo $items->ups_scan_status == 7 ? 'display:block' : 'display:none' ?>" class="reason_for_return_div-<?php echo $items->id; ?>">
											...
											<div style=" width:5%;float:left;">
												<button type="button" class="btn btn-success btn-upsstep5assigndeliveryboy btn-upsstep5assigndeliveryboy-<?php echo $items->id; ?>" data-id="<?php echo $items->id; ?>" data-reason='1' style="border-radius: 0px;height: 34px;">Save</button>
											</div>

											<?php
											$ajaxData = array();
											$dataComments = DB::table('verification_inspection_notes')->where('flag_note', 'R')->where('ups_id', $items->id)->orderBy('id', 'desc')->get();
											if (count($dataComments) > 0)
												$ajaxData['comments'] = $dataComments;
											else
												$ajaxData['comments'] = '';
											...
											<div class="upsstep5assigndeliveryboy-reason-ajax-container upsstep5assigndeliveryboy-reason-ajax-container-<?php echo $items->id; ?>" style="float:left;width:100%;margin-top:15px">
												<div style="float:left;width:100%">
													<h3 style="background: #efefef;border-bottom: 1px solid #000;padding: 10px;width: 100%;float: left;font-size: 15px;margin:0px">Comments</h3>
													<?php if (!empty($ajaxData['comments'])) {
														foreach ($ajaxData['comments'] as $k => $v) { ?>
			...
			<?php /* if (checkNonBoundedWH() == 'Yes' && $items->display_notification_nonbounded_wh == 1) { ?>
				<a style="margin-top: 10px" class="btn btn-success" href="{{route('acceptfilessubmit',[$items->id,'Ups','ups_details'])}}">Receive Shipment</a>
			<?php } else { }*/
			?>
