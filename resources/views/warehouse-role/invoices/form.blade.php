...
<section class="content">
    <div class="box box-success" style="float: left;">
        <div class="box-body">
            <?php
            if ($model->id)
                $actionUrl = url('warehouseinvoices/update', $model->id);
            else
                $actionUrl = url('warehouseinvoices/store');
            ?>
            ...
            <div class="form-group col-md-12 btm-sub">
                ...
                <a class="btn btn-danger" href="{{route('warehouseinvoices')}}" title="">Cancel</a>
            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#file_number').change(function() {
            ...
            var id = $(this).val();
            var urlzt = '<?php echo url("warehouseinvoices/gethawboffiles"); ?>';
            $.ajax({
                url: urlzt,
                async: false,
                dataType: "json",
                            ...
                            success: function(data) {
                                if (data.exist == 1) {
                                    if (confirm("Invoice with Bill No " + bNo + " already created. Do you want to continue with incremented number ?")) {
                                        ...
                                        goAhead = 0;
                                        window.location.href = '<?php echo route("warehouseinvoices") ?>';
                                        event.preventDefault();
                                        return false;
                                    }
                                }
