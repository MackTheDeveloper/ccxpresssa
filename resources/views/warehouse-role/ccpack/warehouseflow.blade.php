...
<section class="content-header" style="float: left;width:100%">
	<h1>
		...
		<?php } else { ?>
			<div style="float: right;margin-right: 15px;color: green;"> File Status : <?php echo isset(Config::get('app.ups_new_scan_status')[!empty($items->ccpack_scan_status) ? $items->ccpack_scan_status : '-']) ? Config::get('app.ups_new_scan_status')[!empty($items->ccpack_scan_status) ? $items->ccpack_scan_status : '-'] : '-'; ?>
			</div>
		<?php } ?>
	</h1>
</section>
<section class="content editupscontainer" style="float: left;width:100%">
	<div class="box box-success">
		<div class="box-body">
			...
			<div class="row">
				<div class="col-md-1">
					<a class="btn round orange btn-warning" href="{{route('viewcourierccpackdetailforwarehousemaster',[$masterId])}}">Back</a>
				</div>
			</div>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('.ccpack_scan_status_outside').change(function() {
			var tVal = $(this).val();
			if (tVal == 7) {
