...
<section class="content">
    <div class="box box-success">
        <div class="box-body">
            ...
            ?>
            {{ Form::open(array('url' => $action ,'class'=>'form-horizontal create-form','id'=>'createforms','autocomplete'=>'off')) }}
            {{ csrf_field() }}
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-4">
                    <div class="form-group {{ $errors->has('from_phone') ? 'has-error' :'' }}">
                        <div class="col-md-5">
            ...
            <div class="col-md-12">
                <div class="col-md-4">
                    <div class="form-group {{ $errors->has('destination_port') ? 'has-error' :'' }}">
                        <div class="col-md-5 required">
            ...
            <div class="col-md-12">
                <div class="col-md-4">
                    <div class="form-group {{ $errors->has('consignee_autocomplete') ? 'has-error' :'' }}">
                        <div class="col-md-5 required">
                ...
                <div class="col-md-4">
                    <div class="form-group {{ $errors->has('consignee_phone') ? 'has-error' :'' }}">
                        <div class="col-md-5">
            ...
            <div class="col-md-12">
                <div class="col-md-4">
                    <div class="form-group {{ $errors->has('total_pieces') ? 'has-error' :'' }}">
                        <div class="col-md-5 required">
                ...
                <div class="col-md-4">
                    <div class="form-group {{ $errors->has('shipment_real_weight') ? 'has-error' :'' }}">
                        <div class="col-md-5 required">
                ...
                <div class="col-md-4">
                    <div class="form-group {{ $errors->has('total_freight') ? 'has-error' :'' }}">
                        <div class="col-md-5 required">
