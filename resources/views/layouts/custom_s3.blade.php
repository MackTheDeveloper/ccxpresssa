...
<body class="skin-green-light">
    <div id="loading">
        @include('layouts.included_css_js_for_s3')
    ...
    <div id="app">
        <nav class="navbar navbar-default navbar-static-top">
            <div class="container-fluid m-0">
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        ?>
                                        ...
                                        <li class="menu-item dropdown dropdown-submenu">
                                            ...
                                            <ul class="dropdown-menu sub-dpmenu">
                                                ...
                                                <?php if ($permissionCourierExpensesListing) { ?>
                                                    <li>
                                                        <a href="{{ route('agentupsexpenses') }}">Manage Expenses</a>
                                                    </li>
                                                <?php } ?>
                                            </ul>
                                        </li>
                            ...
                            <?php } ?>
                            <?php if ($permissionCargoListing || $permissionCargoExpensesListing) { ?>
                                <li class="dropdown">
                                    ...
                                    <ul role="menu" class="dropdown-menu">
                                        ...
                                        <?php if ($permissionCargoExpensesListing) { ?>
                                            <li>
                                                <a href="{{ route('agentexpenses') }}">Manage Expenses</a>
                                            </li>
                                        <?php } ?>
                                    </ul>
                                </li>
                            ...
                            <?php } ?>
                        <?php } else if (auth()->user()->department == 14) { // Warehouse 
                        ?>
                ...
                <?php } ?>
                <?php if ($permissionCargoListing || $permissionCargoInvoicesListing) { ?>
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">Cargo Management<span class="caret"></span></a>
                        <ul role="menu" class="dropdown-menu">
                            <?php if ($permissionCargoListing) { ?>
                ...
                <?php } ?>
            <?php } else if (auth()->user()->department == 11) { // Cashier 
            ?>
                <?php if ($permissionCourierImportListing || $permissionCourierExpensesListing) { ?>
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle main-menu-link" href="#">Courier Management<span class="caret"></span></a>
                        <ul role="menu" class="dropdown-menu">
                            <li class="menu-item dropdown dropdown-submenu">
                                ...
                                <ul class="dropdown-menu sub-dpmenu">
                                    ...
                                    <?php if ($permissionCourierExpensesListing) { ?>
                                        <li>
                                            <a href="{{ route('cashierupsexpenses') }}">Manage Expenses</a>
                                        </li>
                                    <?php } ?>
                                </ul>
                            </li>
                ...
                <?php } ?>
                <?php if ($permissionCargoExpensesListing || $permissionCargoListing || $permissionCargoInvoicesListing) { ?>
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">Cargo Management<span class="caret"></span></a>
                        <ul role="menu" class="dropdown-menu">
                            <?php if ($permissionCargoListing) { ?>
                            ...
                            <?php if ($permissionCargoExpensesListing) { ?>
                                <li>
                                    <a href="{{ route('cashierexpenses') }}">Manage Expenses</a>
                                </li>
                            <?php } ?>
                            <?php if ($permissionCargoInvoicesListing) { ?>
                                <li style="display: none">
            ...
            <?php } else { ?>
                ...
                <?php if ($permissionCargoListing || $permissionCargoExpensesListing || $permissionCargoInvoicesListing) { ?>
                    <li class="dropdown">
                ...
                <li class="dropdown">
                    ...
                    <ul role="menu" class="dropdown-menu">
                        ...
                        <li class="menu-item dropdown dropdown-submenu">
                            ...
                            <ul class="dropdown-menu sub-dpmenu">
                                <li>
                                    <a href="{{ route('statementofaccounts') }}">Statement of accounts</a>
                                </li>
                        ...
                        <li class="menu-item dropdown dropdown-submenu">
                            ...
                            <ul class="dropdown-menu sub-dpmenu">
                                <?php if ($permissionCustomReports) { ?>
                                    <li>
                                        <a href="{{ route('customreport') }}">Custom Report</a>
                                    </li>
                                <?php } ?>
                                <li>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <?php if (auth()->user()->department == 13 || auth()->user()->department == 10) { ?>
                    <li class="dropdown">
                        ...
                        <a data-toggle="dropdown" style="float: left;" class="dropdown-toggle" href="#"><i class="fa fas fa-bell" style="font-size:19px;color:#ffffff;float: left;"></i><span class="adminnotitotal pendingexpense pendingexpenseall"><?php echo $notiAll; ?></span></a>
                        <?php $noti = App\Admin::getNotificationForAdmin();
                ...
                ?>
                    <li class="dropdown">
                        ...
                        <a data-toggle="dropdown" style="float: left;" class="dropdown-toggle" href="#"><i class="fa fas fa-bell" style="font-size:19px;color:#ffffff;float: left;"></i><span class="cashiernotitotal pendingexpense pendingexpenseall"><?php echo $notiAll; ?></span></a>
                        <?php $noti = App\Cashier::getNotificationForCashier();
                        foreach ($noti as $key => $row) {
                            // replace 0 with the field's index/key
                            $notiAll1['notificationDateTime'][$key] = $row->notificationDateTime;
                            $notiAll1['notificationStatus'][$key] = $row->notificationStatus;
                ...
                ?>
                    <li class="dropdown">
                        ...
                        <a data-toggle="dropdown" style="float: left;" class="dropdown-toggle" href="#"><i class="fa fas fa-bell" style="font-size:19px;color:#ffffff;float: left;"></i><span class="agentnotitotal pendingexpense pendingexpenseall"><?php echo $notiAll; ?></span></a>
                        <?php $noti = App\Agent::getNotificationForAgent();
                        foreach ($noti as $key => $row) {
                            // replace 0 with the field's index/key
                            $notiAll1['notificationDateTime'][$key] = $row->notificationDateTime;
                            $notiAll1['notificationStatus'][$key] = $row->notificationStatus;
                ...
                ?>
                        <li class="dropdown">
                            ...
                            <a data-toggle="dropdown" style="float: left;" class="dropdown-toggle" href="#"><i class="fa fas fa-bell" style="font-size:19px;color:#ffffff;float: left;"></i><span class="warehousenotitotal pendingexpense pendingexpenseall"><?php echo $notiAll; ?></span></a>
                            <?php $noti = App\Warehouse::getNotificationForWarehouse();
                            foreach ($noti as $key => $row) {
                                // replace 0 with the field's index/key
                                $notiAll1['notificationDateTime'][$key] = $row->notificationDateTime;
                                $notiAll1['notificationStatus'][$key] = $row->notificationStatus;
        ...
        <?php if (Route::currentRouteName() != 'home' && Route::currentRouteName() != 'homeagent') { ?>
            <div class="breadcrumbs" style="width: 100%;background: #b5b5b5;">
                @section('breadcrumbs')
                @show
            </div>
        <?php } ?>
