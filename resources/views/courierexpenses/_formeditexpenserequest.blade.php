...
<aside class="main-sidebar">
    <ul class="sidemenu nav navbar-nav side-nav">
        ...
        ?>
        <li class="widemenu">
            <a href="{{ route('expenserequestlisting') }}">Expense Listing</a>
        </li>
        <li class="widemenu">
            ...
            <div class="expensemaincontainer">
                            ...
                            <table class="table table-expense" style="width: 1200px;">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 8%;">Cash / Credit</th>
                                ...
                                <tbody>
                                    <?php if (empty($dataExpenseDetails)) { ?>
                                        <tr id="0">
                                            ...
                                            <td><?php echo Form::select('expenseDetails[cash_credit_account][0]', ['Cash' => 'Cash', 'Cheque' => 'Cheque'], '', ['class' => 'form-control selectpicker fassignee']); ?></td>
                                            <td style="pointer-events: none;opacity: 0.5"><?php echo Form::select('expenseDetails[paid_to][0]', $allUsers, Auth::user()->id, ['class' => 'form-control selectpicker fassignee', 'data-live-search' => 'true', 'data-container' => '.expensesubcontainer']); ?></td>
                                        ...
                                        foreach ($dataExpenseDetails as $k => $v) {  ?>
                                            <tr id="<?php echo $i; ?>">
                                                ...
                                                <td><?php echo Form::select("expenseDetails[cash_credit_account][$i]", ['Cash' => 'Cash', 'Cheque' => 'Cheque'], $v->cash_credit_account, ['class' => 'form-control selectpicker fassignee']); ?></td>
                                                <td style="pointer-events: none;opacity: 0.5"><?php echo Form::select("expenseDetails[paid_to][$i]", $allUsers, $v->paid_to, ['class' => 'form-control selectpicker fassignee', 'data-live-search' => 'true', 'data-container' => '.expensesubcontainer']); ?></td>
                                                <td>
                ...
                <div class="col-md-12" style="text-align: center;">
                    ...
                    <div class="form-group" style="padding-top: 28px;">
                        ...
                        $cancleRoute = route('expenserequestlisting');
                        ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('.allcontainer').on("click", ".addmoreexpense", function(e) {
            ...
            var urlzte = '<?php echo url("expense/addmoreexpenseforrequest"); ?>';
            $.ajax({
                url: urlzte,
                type: 'POST',
                data: {
