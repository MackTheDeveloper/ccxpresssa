                            ...
                            <table class="table table-expense" style="width: 1200px;">
                                ...
                                <tbody>
                                    <tr id="0">
                                        ...
                                        <td><?php echo Form::select('expenseDetails[cash_credit_account][0]', ['Cash' => 'Cash', 'Cheque' => 'Cheque'], '', ['id' => 'cash_credit_account-0', 'class' => 'form-control selectpicker fassignee']); ?></td>
                                        <td style="pointer-events: none;opacity: 0.5"><?php echo Form::select('expenseDetails[paid_to][0]', $dataPaidTo, Auth::user()->id, ['id' => 'paid_to-0', 'class' => 'form-control selectpicker fassignee', 'data-live-search' => 'true', 'data-container' => '.expensesubcontainer']); ?></td>
    ...
    $(document).ready(function() {
        ...
        $('#createExpenseForm').validate({
            submitHandler: function(form) {
                ...
                var urlz = '<?php echo url("expense/storeexpenserequest"); ?>';
                $.ajax({
                    url: urlz,
                    type: 'POST',
                    data: formData,
                ...
                if (submitButtonName == 'CreateExpenseFormButtonSaveNext') {
                    ...
                    $("#cash_credit_account-0").val($("#cash_credit_account-0 option:first").val());
                    $("#paid_to-0").val('<?php echo Auth::user()->id; ?>');
                    $('.count_expense').val('1');
