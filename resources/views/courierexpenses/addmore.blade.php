<tr id="{{$counter}}">
                                    ...
                                    <td><?php echo Form::select("expenseDetails[paid_to][$counter]", $allUsers,'',['class'=>'form-control selectpicker fassignee','data-live-search' => 'true','data-container'=>'.expensesubcontainer']); ?></td>
