...
@section('title')
<?php echo $model->expense_id ? 'Update CCPack Master File Expense Request' : 'Create CCPack Master File Expense Request'; ?>
@stop
...
<section class="content-header">
    <h1><?php echo $model->expense_id ? 'Update CCPack Master File Expense Request' : 'Add CCPack Master File Expense Request'; ?></h1>
</section>
                    ...
                    <div class="col-md-4">
                        <div class="form-group {{ $errors->has('file_number') ? 'has-error' :'' }}">
                            ...
                            <div class="col-md-12" style="pointer-events: none;opacity: 0.5">
                                <?php echo Form::select('file_number', $dataFileNumber, $model->ccpack_master_id, ['class' => 'form-control selectpicker ffilenumber', 'data-live-search' => 'true', 'placeholder' => 'Select ...']); ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                        <div class="form-group {{ $errors->has('ccpack_master_id') ? 'has-error' :'' }}">
                            ...
                            <div class="col-md-12" style="pointer-events: none;opacity: 0.5">
                                <?php echo Form::select('ccpack_master_id', $dataAwbNos, $model->ccpack_master_id, ['class' => 'form-control fawb', 'placeholder' => 'Select ...']); ?>
                            </div>
                        </div>
                    </div>
    ...
    $(document).ready(function() {
        ...
        $('#createExpenseForm').validate({
            submitHandler: function(form) {
                ...
                var urlz = '<?php echo url("ccpack-master/expense/update/$model->expense_id"); ?>';
                $.ajax({
                    url: urlz,
                    type: 'POST',
                    data: formData,
                    success: function(data) {
                        ...
                        <?php if ($flagFromWhere == 'flagFromNotificationPage') { ?>
                            window.location.href = "<?php echo route('expensenotificationoffile', [$model->expense_id, 'ccpackMasterExpense']); ?>";
                        <?php } elseif ($flagFromWhere == 'flagFromView') { ?>
                            window.location.href = "<?php echo route('viewdetailsccpackmaster', [$model->ccpack_master_id]); ?>";
                        <?php } else { ?>
