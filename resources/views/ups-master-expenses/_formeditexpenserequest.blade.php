...
@section('title')
<?php echo $model->expense_id ? 'Update UPS Master File Expense Request' : 'Create UPS Master File Expense Request'; ?>
@stop
...
<section class="content-header">
    <h1><?php echo $model->expense_id ? 'Update UPS Master File Expense Request' : 'Add UPS Master File Expense Request'; ?></h1>
</section>
        ...
        <div class="box-body">
            ...
            <div class="expensemaincontainer">
                    ...
                    <div class="col-md-4">
                        <div class="form-group {{ $errors->has('file_number') ? 'has-error' :'' }}">
                            ...
                            <div class="col-md-12" style="pointer-events: none;opacity: 0.5">
                                <?php echo Form::select('file_number', $dataFileNumber, $model->ups_master_id, ['class' => 'form-control selectpicker ffilenumber', 'data-live-search' => 'true', 'placeholder' => 'Select ...']); ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                        <div class="form-group {{ $errors->has('ups_master_id') ? 'has-error' :'' }}">
                            <div class="col-md-12">
                                <?php echo Form::label('ups_master_id', 'AWB / BL No.', ['class' => 'control-label']); ?>
                            </div>
                            <div class="col-md-12" style="pointer-events: none;opacity: 0.5">
                                <?php echo Form::select('ups_master_id', $dataAwbNos, $model->ups_master_id, ['class' => 'form-control fawb', 'placeholder' => 'Select ...']); ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                        <div class="form-group {{ $errors->has('cash_credit_account') ? 'has-error' :'' }}">
                            ...
                            <div class="col-md-12">
                                <?php echo Form::select('cash_credit_account', $cashCredit, $model->cash_credit_account, ['class' => 'form-control selectpicker fcashcredit', 'data-live-search' => 'true', 'placeholder' => 'Select ...']); ?>
                            </div>
                ...
                <div class="col-md-12">
                    <div class="col-md-4">
                        <div class="form-group {{ $errors->has('admin_manager_role') ? 'has-error' :'' }}">
                            ...
                            <div class="col-md-12">
                                <?php echo Form::select('admin_manager_role', $adminManagersRole, $model->admin_manager_role, ['class' => 'form-control selectpicker', 'data-live-search' => 'true']); ?>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4" style="display:none">
                        <div class="form-group {{ $errors->has('admin_managers') ? 'has-error' :'' }}">
                            ...
                            <div class="col-md-12">
                                <?php echo Form::select('admin_managers[]', $adminManagersUsers, $model->admin_managers, ['class' => 'form-control selectpicker', 'data-live-search' => 'true', 'multiple' => true, 'id' => 'admin_managers']); ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12" style="text-align: center;">
                    ...
                    <div class="form-group" style="padding-top: 28px;">
                        ...
                        if ($flagFromWhere == 'flagFromView')
                            ...
                            $cancleRoute = route('upsmasterexpenses');
                        ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        <?php if (empty($model->billing_party) || $model->expense_id) { ?>
            $('.fbl_awb').val($("#ups_master_id option:selected").html());
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                }
            });
            var urlznn = '<?php echo url("ups-master/getupsmasterdata"); ?>';
            $.ajax({
                url: urlznn,
                type: 'POST',
                dataType: "json",
        ...
        $('#file_number').change(function() {
            ...
            if ($(this).val() != '') {
                ...
                var ab = $("#ups_master_id option:selected").html();
                $('.fbl_awb').val(ab);
                ...
                var urlzn = '<?php echo url("ups-master/getupsmasterdata"); ?>';
                $.ajax({
                    url: urlzn,
                    type: 'POST',
                    dataType: "json",
        ...
        $('#createExpenseForm').validate({
            submitHandler: function(form) {
                ...
                var urlz = '<?php echo url("ups-master/expense/updateagentupsmasterexpense/$model->expense_id"); ?>';
                $.ajax({
                    url: urlz,
                    type: 'POST',
                    data: formData,
                    success: function(data) {
                        ...
                        <?php if ($flagFromWhere == 'flagFromView') { ?>
                            window.location.href = '<?php echo route('viewdetailsupsmaster', [$model->ups_master_id]) ?>';
                        <?php } else { ?>
                            window.location.href = '<?php echo route("upsmasterexpenses") ?>';
                        <?php } ?>
                    },
                });
