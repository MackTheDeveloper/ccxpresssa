...
@section('title')
<?php echo $model->id ? 'Update UPS Master File Expense Request' : 'Add UPS Master File Expense Request'; ?>
@stop
...
<section class="content-header">
    <h1><?php echo $model->id ? 'Update UPS Master File Expense Request' : 'Add UPS Master File Expense Request'; ?></h1>
</section>
<section class="content">
    ...
    <div class="box box-success">
        <div class="box-body">
            ...
            <?php
            $actionUrl = route('storeupsexpense');
            ?>
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                        <div class="form-group {{ $errors->has('file_number') ? 'has-error' :'' }}">
                            ...
                            <div class="col-md-12">
                                <?php echo Form::select('file_number', $dataFileNumber, $upsMasterId, ['class' => 'form-control selectpicker ffilenumber', 'data-live-search' => 'true', 'placeholder' => 'Select ...']); ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    <div class="col-md-4">
                        <div class="form-group {{ $errors->has('ups_master_id') ? 'has-error' :'' }}">
                            ...
                            <div class="col-md-12" style="pointer-events: none;opacity: 0.5">
                                <?php echo Form::select('ups_master_id', $dataAwbNos, $upsMasterId, ['class' => 'form-control fawb', 'placeholder' => 'Select ...']); ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12" style="text-align: center;">
                    ...
                    <div class="form-group" style="padding-top: 28px;">
                        ...
                        if ($flagFromWhere == 'flagFromView')
                            $cancleRoute = route('viewdetailsupsmaster', [$upsMasterId]);
                        else
    ...
    $(document).ready(function() {
        ...
        <?php if ($upsMasterId) { ?>
            ...
            $.ajax({
                ...
                dataType: "json",
                data: {
                    'upsMasterId': '<?php echo $upsMasterId; ?>'
                },
                success: function(data) {
        ...
        $('#createExpenseForm').validate({
            ...
            submitHandler: function(form) {
                ...
                var urlz = '<?php echo url("ups-master/expense/store"); ?>';
                $.ajax({
                    url: urlz,
                    async: false,
                    type: 'POST',
                    ...
                    success: function(data) {
                        ...
                        <?php if ($flagFromWhere == 'flagFromView') { ?>
                            window.location.href = '<?php echo route('viewdetailsupsmaster', [$upsMasterId]) ?>';
                        <?php } else { ?>
                            window.location.href = '<?php echo route("upsmasterexpenses") ?>';
                        <?php } ?>
                ...
                if (submitButtonName == 'CreateExpenseFormButtonSaveNext') {
                    window.location.href = '<?php echo route("createupsmasterexpense") ?>';
                    ...
                    $('.count_expense').val('1');
                    var urlznt = '<?php echo url("ups-master/expense/generateupsmastervoucheronsavenext"); ?>';
                    $.ajax({
                        url: urlznt,
                        type: 'POST',
                        data: formData,
        ...
        $('.allcontainer').on("click", ".addmoreexpense", function(e) {
            ...
            $('.count_expense').val(Number($('.count_expense').val()) + 1);
            counter = counter + 1;
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
