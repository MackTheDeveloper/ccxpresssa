		...
		<div class="box-body">
			...
			<div class="edit-btn">
				...
				if ($model->request_by_role == 12)
					$editLing = route('edithousefileexpenserequestedbyagent', [$model->expense_id]);
				else
					$editLing = route('edithousefileexpense', [$model->expense_id]);
				?>
			...
			<div class="detail-container">
				<div style="float: left;width: 50%; margin-bottom: 10px;">
					...
					<span class="viewblk2">
						<?php $data = App\HawbFiles::getHouseFileData($model->house_file_id);
				...
				<div style="float: left;width: 50%; margin-bottom: 10px;">
					...
					<span class="viewblk2">
						<?php
						$dataHAWB = App\HawbFiles::getHouseFileData($model->house_file_id);
						if ($dataHAWB->cargo_operation_type == 1)
							echo !empty($data->hawb_hbl_no) ? $data->hawb_hbl_no : '-';
						else
							echo !empty($data->export_hawb_hbl_no) ? $data->export_hawb_hbl_no : '-';
						?>
					</span>
				</div>
				<div style="float: left;width: 50%; margin-bottom: 10px;">
