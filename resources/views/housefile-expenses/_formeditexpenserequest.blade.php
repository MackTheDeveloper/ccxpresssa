...
@section('title')
<?php echo $model->expense_id ? 'Update Cargo File Expense Request' : 'Create Cargo File Expense Request'; ?>
@stop
@section('sidebar')
<?php
...
<section class="content-header">
    <h1><?php echo $model->expense_id ? 'Update Cargo File Expense Request' : 'Add Cargo File Expense Request'; ?></h1>
</section>
                    ...
                    <div class="col-md-4">
                        <div class="form-group {{ $errors->has('file_number') ? 'has-error' :'' }}">
                            ...
                            <div class="col-md-12" style="pointer-events: none;opacity: 0.5">
                                <?php echo Form::select('file_number', $dataFileNumber, $model->house_file_id, ['class' => 'form-control selectpicker ffilenumber', 'data-live-search' => 'true', 'placeholder' => 'Select ...']); ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                        <div class="form-group {{ $errors->has('house_file_id') ? 'has-error' :'' }}">
                            ...
                            <div class="col-md-12" style="pointer-events: none;opacity: 0.5">
                                <?php echo Form::select('house_file_id', $dataAwbNos, $model->house_file_id, ['class' => 'form-control fawb', 'placeholder' => 'Select ...']); ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12" style="text-align: center;">
                    ...
                    <div class="form-group" style="padding-top: 28px;">
                        ...
                        if ($flagFromWhere == 'flagFromView')
                            $cancleRoute = route('viewhawbfile', [$model->house_file_id]);
                        else
    ...
    $(document).ready(function() {
        ...
        <?php if (empty($model->billing_party) || $model->expense_id) { ?>
            ...
            $.ajax({
                ...
                dataType: "json",
                data: {
                    'houseId': '<?php echo $model->house_file_id; ?>'
                },
                success: function(data) {
        ...
        $('#createExpenseForm').validate({
            submitHandler: function(form) {
                ...
                var urlz = '<?php echo url("housefileexpense/updaterequestedbyagent/$model->expense_id"); ?>';
                $.ajax({
                    url: urlz,
                    type: 'POST',
                    data: formData,
                    success: function(data) {
                        ...
                        <?php if ($flagFromWhere == 'flagFromView') { ?>
                            window.location.href = '<?php echo route('viewhawbfile', [$model->house_file_id]) ?>';
                        <?php } else { ?>
