                ...
                <div class="col-md-12" style="text-align: center;">
                    ...
                    <div class="form-group" style="padding-top: 28px;">
                        ...
                        if ($flagFromWhere == 'flagFromView')
                            $cancleRoute = route('viewhawbfile', [$houseId]);
                        else
                            $cancleRoute = route('housefileexpenses');
                        ?>
    ...
    $(document).ready(function() {
        ...
        $('#createExpenseForm').validate({
            ...
            submitHandler: function(form) {
                ...
                var urlz = '<?php echo url("housefileexpense/store"); ?>';
                $.ajax({
                    url: urlz,
                    async: false,
                    type: 'POST',
                    ...
                    success: function(data) {
                        ...
                        <?php if ($flagFromWhere == 'flagFromView') { ?>
                            window.location.href = '<?php echo route('viewhawbfile', [$houseId]) ?>';
                        <?php } else { ?>
                            window.location.href = '<?php echo route("housefileexpenses") ?>';
                        <?php } ?>
                ...
                if (submitButtonName == 'CreateExpenseFormButtonSaveNext') {
                    window.location.href = '<?php echo route("createhousefileexpense") ?>';
