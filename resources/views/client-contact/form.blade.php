...
<aside class="main-sidebar">
    <ul class="sidemenu nav navbar-nav side-nav">
        <li class="widemenu">
            <a href="{{ route('clientcontacts') }}">Manage Client Contacts</a>
        </li>
    </ul>
</aside>
@stop
...
<section class="content">
    <div class="box box-success">
        <div class="box-body">
                    <?php
                    if($model->id)
                        $actionUrl = url('clientcontact/update',$model->id);
                    else
                        $actionUrl = url('clientcontact/store');    
                    ?>
             ...
             <div class="col-md-12">
                <div class="col-md-4">
                    <div class="form-group {{ $errors->has('client_id') ? 'has-error' :'' }}">
                        ...
                        <?php echo Form::label('client_id', 'Billing Party',['class'=>'control-label']); ?>
                        </div>
            ...
            <div class="form-group col-md-12 btm-sub">
                            ...
                            <a class="btn btn-danger" href="{{url('clientcontacts')}}" title="">Cancel</a>
            </div>
