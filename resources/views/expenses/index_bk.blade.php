    ...
    <div class="box box-success">
        <div class="box-body">
            <div style="float: right;width: 200px;margin: 0px;height: 35px;position: absolute;left: 70%;z-index: 111;top: 18px;">
                <a title="Click here to print"  target="_blank" href="{{ route('getprintallexpense') }}"><i class="fa fa-print btn btn-primary"></i></a>
            </div>
        ...
        <tbody>
            ...
            @foreach ($cargoExpenseDataByVoucher as $items)
             <?php $dataExpenses = App\ExpenseDetails::checkExpense($items->expense_id); 
                ...
                ?>
                <tr data-editlink="{{ route('viewdetailscargoexpense',$items->expense_id) }}" id="<?php echo $items->expense_id; ?>" class="edit-row">
