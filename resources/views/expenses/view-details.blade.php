		...
		<div class="box-body">
			...
			<div class="edit-btn">
				...
				if ($model->request_by_role == 12)
					$editLing = route('editagentexpensesbyadmin', [$model->expense_id, 'flagFromExpenseListing']);
				else
					$editLing = route('editexpensevoucher', [$model->expense_id, 'flagFromExpenseListing']);
				?>
			...
			<div class="detail-container">
				<div style="float: left;width: 50%; margin-bottom: 10px;">
					...
					<span class="viewblk2">
						<?php $data = App\Cargo::getCargoData($model->cargo_id);
				...
				<div style="float: left;width: 50%; margin-bottom: 10px;">
					...
					<span class="viewblk2">
						<?php $data = App\Cargo::getCargoData($model->cargo_id);
						echo !empty($data->awb_bl_no) ? $data->awb_bl_no : '-'; ?>
					</span>
				</div>
				<div style="float: left;width: 50%; margin-bottom: 10px;">
