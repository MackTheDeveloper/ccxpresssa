...
@section('title')
<?php echo $model->id ? 'Update Custom' : 'Add Custom'; ?>
@stop
@section('sidebar')
<aside class="main-sidebar">
    <ul class="sidemenu nav navbar-nav side-nav">
        ...
        ?>
         ...
         <li class="widemenu">
            <a href="{{ route('expenses') }}">Custom Listing</a>
        </li>
...
<section class="content-header">
    <h1><?php echo $model->id ? 'Update Custom' : 'Add Custom'; ?></h1>
</section>
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-3">
                        <div class="form-group {{ $errors->has('custom_file_number') ? 'has-error' :'' }}">
                            ...
                            <div class="col-md-12">
                                <?php echo Form::text('custom_file_number','',['class'=>'form-control fcustomfilenumber','placeholder' => '']); ?>
                            </div>
                            ...
                            <table class="table table-expense" style="width: 1200px;">
                                ...
                                <tbody>
                                    <tr id="0">
                                        ...
                                        <td><?php echo Form::select('customDetails[expense_type][0]', $dataCost,'',['class'=>'form-control expense_type selectpicker fexpense_type','data-live-search' => 'true','id'=>'expense_type-0','data-expense_type'=>'0','placeholder' => 'Select ...','data-container'=>'.expensesubcontainer']); ?></td>
                                        <td><?php echo Form::textarea('customDetails[description][0]','',['class'=>'form-control cvalidation','id'=>'description-0','rows'=>1]); ?></td>
                                        <td><?php echo Form::text('customDetails[amount][0]','0.00',['class'=>'form-control cvalidation famount','placeholder' => '','onkeypress'=>'return isNumber(event)']); ?></td>
                                        <td><?php echo Form::select('customDetails[paid_to][0]', $allUsers,'',['id'=>'paid_to-0','class'=>'form-control selectpicker fassignee','data-live-search' => 'true','data-container'=>'.expensesubcontainer']); ?></td>
...
$(document).ready(function() {
                ...
                $('#file_number').change(function(){
                    ...
                    url:urlzt,
                    type:'POST',
                    data:{'courierId':$(this).val(),'flag':'<?php echo "cargo" ?>'},
                    success:function(data) {
                    $('#loading').hide();
                ...
                $('#createExpenseForm').on('submit', function (event) {
                    ...
                    $('.fcustomfilenumber').each(function () {
                        $(this).rules("add",
                        {
                        required: true,
                        })
                ...
                $('#createExpenseForm').validate({
                    submitHandler: function (form) {
                        ...
                        $.ajax({
                            ...
                            url:urlzte,
                            type:'POST',
                            data:{'tId':$('#cash_credit_account').val()},
