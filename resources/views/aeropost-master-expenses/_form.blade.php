...
@section('title')
<?php echo $model->id ? 'Update Aeropost Master File Expense Request' : 'Add Aeropost Master File Expense Request'; ?>
@stop
...
<section class="content-header">
    <h1><?php echo $model->id ? 'Update Aeropost Master File Expense Request' : 'Add Aeropost Master File Expense Request'; ?></h1>
</section>
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                        <div class="form-group {{ $errors->has('file_number') ? 'has-error' :'' }}">
                            ...
                            <div class="col-md-12">
                                <?php echo Form::select('file_number', $dataFileNumber, $aeropostMasterId, ['class' => 'form-control selectpicker ffilenumber', 'data-live-search' => 'true', 'placeholder' => 'Select ...']); ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    <div class="col-md-4">
                        <div class="form-group {{ $errors->has('aeropost_master_id') ? 'has-error' :'' }}">
                            ...
                            <div class="col-md-12" style="pointer-events: none;opacity: 0.5">
                                <?php echo Form::select('aeropost_master_id', $dataAwbNos, $aeropostMasterId, ['class' => 'form-control fawb', 'placeholder' => 'Select ...']); ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12" style="text-align: center;">
                    ...
                    <div class="form-group" style="padding-top: 28px;">
                        ...
                        elseif ($flagFromWhere == 'flagFromView')
                            $cancleRoute = route('viewdetailsaeropostmaster', [$aeropostMasterId]);
                        else
    ...
    $(document).ready(function() {
        ...
        <?php if ($aeropostMasterId) { ?>
            ...
            $.ajax({
                ...
                dataType: "json",
                data: {
                    'aeropostMasterId': '<?php echo $aeropostMasterId; ?>'
                },
                success: function(data) {
        ...
        $('#createExpenseForm').validate({
            ...
            submitHandler: function(form) {
                ...
                var urlz = '<?php echo url("aeropost-master/expense/store"); ?>';
                $.ajax({
                    url: urlz,
                    async: false,
                    type: 'POST',
                    ...
                    success: function(data) {
                        ...
                        <?php if ($flagFromWhere == 'flagFromView') { ?>
                            window.location.href = '<?php echo route('viewdetailsaeropostmaster', [$aeropostMasterId]) ?>';
                        <?php } else { ?>
                            window.location.href = '<?php echo route("aeropostmasterexpenses") ?>';
                        <?php } ?>
                ...
                if (submitButtonName == 'CreateExpenseFormButtonSaveNext') {
                    window.location.href = '<?php echo route("createaeropostmasterexpense") ?>';
                } else {
