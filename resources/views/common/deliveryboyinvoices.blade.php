...
<body>
    <?php
    $getTotalNoOfInvoices = app('App\Common')->getTotalNoOfInvoices($selectedIds, $flagModule);
    $i = 1;
    foreach ($selectedIds as $k => $v) {
        $dataInvoices = app('App\Common')->getInvoicesOfCouriers($v, $flagModule);
        foreach ($dataInvoices as $k => $v) {
            $invoice = (array) $v;
    ?>
                    ...
                    <div class="box-body cargo-forms" style="color: #000">
                        ...
                        <h3 style="background: #ccc;padding:5px;font-weight:normal;width:100%">
                            ...
                            <div style="float: right;width: 50%;text-align: right;">
                                <b>Currency : <?php $data = app('App\Currency')::getData($invoice['currency']);
                        ...
                        <div class="col-md-12" style="margin-top: 20px">
                            ...
                            <div class="sec3" style="float: left;width: 100%;margin-top: 10px">
                                ...
                                <div style="width: 48%;float: left;margin-left: 30px;border: 1px solid #ccc;">
                                    ...
                                    <div style="height: 100px;padding: 10px"><?php echo $invoice['consignee_address']; ?></div>
                                </div>
                            </div>
                            ...
                            <div style="float: left;width: 100%;margin-top: 10px">
                                <div style="width: 50%;float: left">
                                    <div style="width: 70%;margin-top: 50%;margin-bottom: 2%;border-bottom: 1px solid #ccc;"></div>
